...
func RegisterFeatureFlagAPIHandlerServer(ctx context.Context, mux *runtime.ServeMux, server FeatureFlagAPIServer) error {
	...
	mux.Handle("POST", pattern_FeatureFlagAPI_GetFlags_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		ctx, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/clutch.featureflag.v1.FeatureFlagAPI/GetFlags", runtime.WithHTTPPathPattern("/v1/featureflag/getFlags"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_FeatureFlagAPI_GetFlags_0(ctx, inboundMarshaler, server, req, pathParams)
		...
		forward_FeatureFlagAPI_GetFlags_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterFeatureFlagAPIHandlerClient(ctx context.Context, mux *runtime.ServeMux, client FeatureFlagAPIClient) error {
	...
	mux.Handle("POST", pattern_FeatureFlagAPI_GetFlags_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		var err error
		ctx, err = runtime.AnnotateContext(ctx, mux, req, "/clutch.featureflag.v1.FeatureFlagAPI/GetFlags", runtime.WithHTTPPathPattern("/v1/featureflag/getFlags"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_FeatureFlagAPI_GetFlags_0(ctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
