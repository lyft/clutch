...
func RegisterAuditAPIHandlerServer(ctx context.Context, mux *runtime.ServeMux, server AuditAPIServer) error {
	...
	mux.Handle("POST", pattern_AuditAPI_GetEvents_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		ctx, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/clutch.audit.v1.AuditAPI/GetEvents", runtime.WithHTTPPathPattern("/v1/audit/getEvents"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_AuditAPI_GetEvents_0(ctx, inboundMarshaler, server, req, pathParams)
...
func RegisterAuditAPIHandlerClient(ctx context.Context, mux *runtime.ServeMux, client AuditAPIClient) error {
	...
	mux.Handle("POST", pattern_AuditAPI_GetEvents_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		var err error
		ctx, err = runtime.AnnotateContext(ctx, mux, req, "/clutch.audit.v1.AuditAPI/GetEvents", runtime.WithHTTPPathPattern("/v1/audit/getEvents"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_AuditAPI_GetEvents_0(ctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
