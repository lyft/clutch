...
type HTTPFaultConfig_AbortFault struct {
	// The abort fault.
	AbortFault *AbortFault `protobuf:"bytes,1,opt,name=abort_fault,json=abortFault,proto3,oneof"`
}

type HTTPFaultConfig_LatencyFault struct {
	// The latency fault.
	LatencyFault *LatencyFault `protobuf:"bytes,2,opt,name=latency_fault,json=latencyFault,proto3,oneof"`
}
...
func (x *AbortFault) GetFaultTargeting() *FaultTargeting {
	if x != nil {
...
func (x *AbortFault) GetFaultParcentage() *FaultPercentage {
	if x != nil {
...
func (x *AbortFault) GetFaultAbortStatus() *FaultAbortStatus {
	if x != nil {
...
func (x *LatencyFault) GetFaultTargeting() *FaultTargeting {
	if x != nil {
		return x.FaultTargeting
	}
	return nil
...
func (x *LatencyFault) GetFaultParcentage() *FaultPercentage {
	if x != nil {
		return x.FaultParcentage
	}
	return nil
...
func (x *LatencyFault) GetFaultLatencyDuration() *FaultLatencyDuration {
	if x != nil {
...
var file_chaos_serverexperimentation_v1_serverexperimentation_proto_rawDesc = []byte{
	...
	0x73, 0x22, 0xd1, 0x01, 0x0a, 0x0f, 0x48, 0x54, 0x54, 0x50, 0x46, 0x61, 0x75, 0x6c, 0x74, 0x43,
	0x6f, 0x6e, 0x66, 0x69, 0x67, 0x12, 0x54, 0x0a, 0x0b, 0x61, 0x62, 0x6f, 0x72, 0x74, 0x5f, 0x66,
	0x61, 0x75, 0x6c, 0x74, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x31, 0x2e, 0x63, 0x6c, 0x75,
	...
	0x76, 0x31, 0x2e, 0x41, 0x62, 0x6f, 0x72, 0x74, 0x46, 0x61, 0x75, 0x6c, 0x74, 0x48, 0x00, 0x52,
	0x0a, 0x61, 0x62, 0x6f, 0x72, 0x74, 0x46, 0x61, 0x75, 0x6c, 0x74, 0x12, 0x5a, 0x0a, 0x0d, 0x6c,
	0x61, 0x74, 0x65, 0x6e, 0x63, 0x79, 0x5f, 0x66, 0x61, 0x75, 0x6c, 0x74, 0x18, 0x02, 0x20, 0x01,
	0x28, 0x0b, 0x32, 0x33, 0x2e, 0x63, 0x6c, 0x75, 0x74, 0x63, 0x68, 0x2e, 0x63, 0x68, 0x61, 0x6f,
	...
	0x63, 0x79, 0x46, 0x61, 0x75, 0x6c, 0x74, 0x48, 0x00, 0x52, 0x0c, 0x6c, 0x61, 0x74, 0x65, 0x6e,
	0x63, 0x79, 0x46, 0x61, 0x75, 0x6c, 0x74, 0x42, 0x0c, 0x0a, 0x05, 0x66, 0x61, 0x75, 0x6c, 0x74,
	0x12, 0x03, 0xf8, 0x42, 0x01, 0x22, 0xd4, 0x02, 0x0a, 0x0a, 0x41, 0x62, 0x6f, 0x72, 0x74, 0x46,
	0x61, 0x75, 0x6c, 0x74, 0x12, 0x68, 0x0a, 0x0f, 0x66, 0x61, 0x75, 0x6c, 0x74, 0x5f, 0x74, 0x61,
	...
	0x66, 0x61, 0x75, 0x6c, 0x74, 0x54, 0x61, 0x72, 0x67, 0x65, 0x74, 0x69, 0x6e, 0x67, 0x12, 0x6b,
	0x0a, 0x10, 0x66, 0x61, 0x75, 0x6c, 0x74, 0x5f, 0x70, 0x61, 0x72, 0x63, 0x65, 0x6e, 0x74, 0x61,
	0x67, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x36, 0x2e, 0x63, 0x6c, 0x75, 0x74, 0x63,
	...
	0x42, 0x08, 0xfa, 0x42, 0x05, 0x8a, 0x01, 0x02, 0x10, 0x01, 0x52, 0x0f, 0x66, 0x61, 0x75, 0x6c,
	0x74, 0x50, 0x61, 0x72, 0x63, 0x65, 0x6e, 0x74, 0x61, 0x67, 0x65, 0x12, 0x6f, 0x0a, 0x12, 0x66,
	0x61, 0x75, 0x6c, 0x74, 0x5f, 0x61, 0x62, 0x6f, 0x72, 0x74, 0x5f, 0x73, 0x74, 0x61, 0x74, 0x75,
	0x73, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x37, 0x2e, 0x63, 0x6c, 0x75, 0x74, 0x63, 0x68,
	...
	0x46, 0x61, 0x75, 0x6c, 0x74, 0x41, 0x62, 0x6f, 0x72, 0x74, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73,
	0x42, 0x08, 0xfa, 0x42, 0x05, 0x8a, 0x01, 0x02, 0x10, 0x01, 0x52, 0x10, 0x66, 0x61, 0x75, 0x6c,
	0x74, 0x41, 0x62, 0x6f, 0x72, 0x74, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x22, 0xe2, 0x02, 0x0a,
	0x0c, 0x4c, 0x61, 0x74, 0x65, 0x6e, 0x63, 0x79, 0x46, 0x61, 0x75, 0x6c, 0x74, 0x12, 0x68, 0x0a,
	0x0f, 0x66, 0x61, 0x75, 0x6c, 0x74, 0x5f, 0x74, 0x61, 0x72, 0x67, 0x65, 0x74, 0x69, 0x6e, 0x67,
	...
	0x61, 0x75, 0x6c, 0x74, 0x54, 0x61, 0x72, 0x67, 0x65, 0x74, 0x69, 0x6e, 0x67, 0x42, 0x08, 0xfa,
	0x42, 0x05, 0x8a, 0x01, 0x02, 0x10, 0x01, 0x52, 0x0e, 0x66, 0x61, 0x75, 0x6c, 0x74, 0x54, 0x61,
	0x72, 0x67, 0x65, 0x74, 0x69, 0x6e, 0x67, 0x12, 0x6b, 0x0a, 0x10, 0x66, 0x61, 0x75, 0x6c, 0x74,
	0x5f, 0x70, 0x61, 0x72, 0x63, 0x65, 0x6e, 0x74, 0x61, 0x67, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28,
	...
	0x02, 0x10, 0x01, 0x52, 0x0f, 0x66, 0x61, 0x75, 0x6c, 0x74, 0x50, 0x61, 0x72, 0x63, 0x65, 0x6e,
	0x74, 0x61, 0x67, 0x65, 0x12, 0x7b, 0x0a, 0x16, 0x66, 0x61, 0x75, 0x6c, 0x74, 0x5f, 0x6c, 0x61,
	...
	,
	...
	0x61, 0x74, 0x69, 0x6f, 0x6e, 0x2e, 0x76, 0x31, 0x2e, 0x44, 0x6f, 0x77, 0x6e, 0x73, 0x74, 0x72,
	0x65, 0x61, 0x6d, 0x45, 0x6e, 0x66, 0x6f, 0x72, 0x63, 0x69, 0x6e, 0x67, 0x48, 0x00, 0x52, 0x0a,
	0x64, 0x6f, 0x77, 0x6e, 0x73, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x42, 0x0f, 0x0a, 0x08, 0x65, 0x6e,
...
var file_chaos_serverexperimentation_v1_serverexperimentation_proto_depIdxs = []int32{
	...
	6,  // 4: clutch.chaos.serverexperimentation.v1.HTTPFaultConfig.abort_fault:type_name -> clutch.chaos.serverexperimentation.v1.AbortFault
	7,  // 5: clutch.chaos.serverexperimentation.v1.HTTPFaultConfig.latency_fault:type_name -> clutch.chaos.serverexperimentation.v1.LatencyFault
	8,  // 6: clutch.chaos.serverexperimentation.v1.AbortFault.fault_targeting:type_name -> clutch.chaos.serverexperimentation.v1.FaultTargeting
	14, // 7: clutch.chaos.serverexperimentation.v1.AbortFault.fault_parcentage:type_name -> clutch.chaos.serverexperimentation.v1.FaultPercentage
	15, // 8: clutch.chaos.serverexperimentation.v1.AbortFault.fault_abort_status:type_name -> clutch.chaos.serverexperimentation.v1.FaultAbortStatus
	8,  // 9: clutch.chaos.serverexperimentation.v1.LatencyFault.fault_targeting:type_name -> clutch.chaos.serverexperimentation.v1.FaultTargeting
	14, // 10: clutch.chaos.serverexperimentation.v1.LatencyFault.fault_parcentage:type_name -> clutch.chaos.serverexperimentation.v1.FaultPercentage
	16, // 11: clutch.chaos.serverexperimentation.v1.LatencyFault.fault_latency_duration:type_name -> clutch.chaos.serverexperimentation.v1.FaultLatencyDuration
