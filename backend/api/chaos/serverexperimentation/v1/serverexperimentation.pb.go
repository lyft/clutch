...
const (
	...
	FaultInjectionType_FAULTINJECTIONTYPE_UNSPECIFIED FaultInjectionType = 0
	// Faults are injected to ingress traffic by an upstream service(s).
	FaultInjectionType_FAULTINJECTIONTYPE_INGRESS FaultInjectionType = 1
	// Faults are injected to egress traffic by a downstream service(s).
	FaultInjectionType_FAULTINJECTIONTYPE_EGRESS FaultInjectionType = 2
)

// Enum value maps for FaultInjectionType.
var (
	FaultInjectionType_name = map[int32]string{
		0: "FAULTINJECTIONTYPE_UNSPECIFIED",
		1: "FAULTINJECTIONTYPE_INGRESS",
		2: "FAULTINJECTIONTYPE_EGRESS",
	}
	FaultInjectionType_value = map[string]int32{
...
func (x FaultInjectionType) Enum() *FaultInjectionType {
	p := new(FaultInjectionType)
	*p = x
	return p
}

func (x FaultInjectionType) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (FaultInjectionType) Descriptor() protoreflect.EnumDescriptor {
	return file_chaos_serverexperimentation_v1_serverexperimentation_proto_enumTypes[0].Descriptor()
}

func (FaultInjectionType) Type() protoreflect.EnumType {
	return &file_chaos_serverexperimentation_v1_serverexperimentation_proto_enumTypes[0]
}

func (x FaultInjectionType) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use FaultInjectionType.Descriptor instead.
func (FaultInjectionType) EnumDescriptor() ([]byte, []int) {
...
type TestConfig struct {
	...
	FaultInjectionType FaultInjectionType `protobuf:"varint,4,opt,name=fault_injection_type,json=faultInjectionType,proto3,enum=clutch.chaos.serverexperimentation.v1.FaultInjectionType" json:"fault_injection_type,omitempty"`
}
...
func (x *TestConfig) GetFaultInjectionType() FaultInjectionType {
	if x != nil {
		return x.FaultInjectionType
	}
	return FaultInjectionType_FAULTINJECTIONTYPE_UNSPECIFIED
}
...
var file_chaos_serverexperimentation_v1_serverexperimentation_proto_rawDesc = []byte{
	...
	0x0a, 0x54, 0x65, 0x73, 0x74, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x12, 0x5b, 0x0a, 0x0c, 0x63,
	...
	0x72, 0x50, 0x61, 0x69, 0x72, 0x54, 0x61, 0x72, 0x67, 0x65, 0x74, 0x52, 0x0b, 0x63, 0x6c, 0x75,
	0x73, 0x74, 0x65, 0x72, 0x50, 0x61, 0x69, 0x72, 0x12, 0x4f, 0x0a, 0x05, 0x61, 0x62, 0x6f, 0x72,
	0x74, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x37, 0x2e, 0x63, 0x6c, 0x75, 0x74, 0x63, 0x68,
	...
	0x41, 0x62, 0x6f, 0x72, 0x74, 0x46, 0x61, 0x75, 0x6c, 0x74, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67,
	0x48, 0x00, 0x52, 0x05, 0x61, 0x62, 0x6f, 0x72, 0x74, 0x12, 0x55, 0x0a, 0x07, 0x6c, 0x61, 0x74,
	0x65, 0x6e, 0x63, 0x79, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x39, 0x2e, 0x63, 0x6c, 0x75,
	...
	0x76, 0x31, 0x2e, 0x4c, 0x61, 0x74, 0x65, 0x6e, 0x63, 0x79, 0x46, 0x61, 0x75, 0x6c, 0x74, 0x43,
	0x6f, 0x6e, 0x66, 0x69, 0x67, 0x48, 0x00, 0x52, 0x07, 0x6c, 0x61, 0x74, 0x65, 0x6e, 0x63, 0x79,
	0x12, 0x6b, 0x0a, 0x14, 0x66, 0x61, 0x75, 0x6c, 0x74, 0x5f, 0x69, 0x6e, 0x6a, 0x65, 0x63, 0x74,
	0x69, 0x6f, 0x6e, 0x5f, 0x74, 0x79, 0x70, 0x65, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x39,
	...
	0x69, 0x6f, 0x6e, 0x2e, 0x76, 0x31, 0x2e, 0x46, 0x61, 0x75, 0x6c, 0x74, 0x49, 0x6e, 0x6a, 0x65,
	0x63, 0x74, 0x69, 0x6f, 0x6e, 0x54, 0x79, 0x70, 0x65, 0x52, 0x12, 0x66, 0x61, 0x75, 0x6c, 0x74,
	0x49, 0x6e, 0x6a, 0x65, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x54, 0x79, 0x70, 0x65, 0x42, 0x07, 0x0a,
	0x05, 0x66, 0x61, 0x75, 0x6c, 0x74, 0x22, 0x7f, 0x0a, 0x11, 0x43, 0x6c, 0x75, 0x73, 0x74, 0x65,
	0x72, 0x50, 0x61, 0x69, 0x72, 0x54, 0x61, 0x72, 0x67, 0x65, 0x74, 0x12, 0x36, 0x0a, 0x12, 0x64,
	...
	,
	...
	,
...
var file_chaos_serverexperimentation_v1_serverexperimentation_proto_goTypes = []interface{}{
	(FaultInjectionType)(0),    // 0: clutch.chaos.serverexperimentation.v1.FaultInjectionType
...
var file_chaos_serverexperimentation_v1_serverexperimentation_proto_depIdxs = []int32{
	...
	0, // 3: clutch.chaos.serverexperimentation.v1.TestConfig.fault_injection_type:type_name -> clutch.chaos.serverexperimentation.v1.FaultInjectionType
