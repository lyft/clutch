...
func (x *CreateExperimentsRequest) GetConfig() *any.Any {
	if x != nil {
		return x.Config
	}
	return nil
...
func (x *CreateExperimentsRequest) GetStartTime() *timestamp.Timestamp {
	if x != nil {
		return x.StartTime
	}
	return nil
...
func (x *CreateExperimentsRequest) GetEndTime() *timestamp.Timestamp {
	if x != nil {
		return x.EndTime
	}
	return nil
