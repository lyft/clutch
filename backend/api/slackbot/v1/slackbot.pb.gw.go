...
func RegisterSlackBotAPIHandlerServer(ctx context.Context, mux *runtime.ServeMux, server SlackBotAPIServer) error {
	...
	mux.Handle("POST", pattern_SlackBotAPI_Event_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		rctx, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/clutch.slackbot.v1.SlackBotAPI/Event")
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_SlackBotAPI_Event_0(rctx, inboundMarshaler, server, req, pathParams)
		...
		forward_SlackBotAPI_Event_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterSlackBotAPIHandlerClient(ctx context.Context, mux *runtime.ServeMux, client SlackBotAPIClient) error {
	...
	mux.Handle("POST", pattern_SlackBotAPI_Event_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateContext(ctx, mux, req, "/clutch.slackbot.v1.SlackBotAPI/Event")
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_SlackBotAPI_Event_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
...
var (
	pattern_SlackBotAPI_Event_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"v1", "slackbot", "event"}, ""))
)
