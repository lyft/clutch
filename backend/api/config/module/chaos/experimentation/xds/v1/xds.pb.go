...
type Config struct {
	...
	// list of clusters for which ECDS is enabled. * means it will be enabled for all
	EcdsEnabledClusters []string `protobuf:"bytes,7,rep,name=ecds_enabled_clusters,json=ecdsEnabledClusters,proto3" json:"ecds_enabled_clusters,omitempty"`
	// A prefix to use to override runtime keys for ECDS
	EcdsFaultRuntimePrefix string `protobuf:"bytes,8,opt,name=ecds_fault_runtime_prefix,json=ecdsFaultRuntimePrefix,proto3" json:"ecds_fault_runtime_prefix,omitempty"`
}
...
func (x *Config) GetEcdsEnabledClusters() []string {
	if x != nil {
		return x.EcdsEnabledClusters
	}
	return nil
}

func (x *Config) GetEcdsFaultRuntimePrefix() string {
	if x != nil {
		return x.EcdsFaultRuntimePrefix
	}
	return ""
}
...
var file_config_module_chaos_experimentation_xds_v1_xds_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x22, 0x81, 0x04, 0x0a, 0x06, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x12, 0x2f, 0x0a,
	...
	,
	...
	0x66, 0x69, 0x67, 0x2f, 0x6d, 0x6f, 0x64, 0x75, 0x6c, 0x65, 0x2f, 0x63, 0x68, 0x61, 0x6f, 0x73,
	0x2f, 0x65, 0x78, 0x70, 0x65, 0x72, 0x69, 0x6d, 0x65, 0x6e, 0x74, 0x61, 0x74, 0x69, 0x6f, 0x6e,
	0x2f, 0x78, 0x64, 0x73, 0x2f, 0x76, 0x31, 0x3b, 0x78, 0x64, 0x73, 0x76, 0x31, 0x62, 0x06, 0x70,
...
var file_config_module_chaos_experimentation_xds_v1_xds_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
...
var file_config_module_chaos_experimentation_xds_v1_xds_proto_depIdxs = []int32{
	1, // 0: clutch.config.module.chaos.experimentation.xds.v1.Config.cache_refresh_interval:type_name -> google.protobuf.Duration
	1, // 1: clutch.config.module.chaos.experimentation.xds.v1.Config.resource_ttl:type_name -> google.protobuf.Duration
	1, // 2: clutch.config.module.chaos.experimentation.xds.v1.Config.heartbeat_interval:type_name -> google.protobuf.Duration
