...
type Config struct {
	...
	AwsClient *AWSClient `protobuf:"bytes,2,opt,name=aws_client,json=awsClient,proto3" json:"aws_client,omitempty"`
}
...
func (x *Config) GetAwsClient() *AWSClient {
	if x != nil {
		return x.AwsClient
	}
	return nil
...
func (x *AWSClient) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AWSClient) ProtoMessage() {}

func (x *AWSClient) ProtoReflect() protoreflect.Message {
	mi := &file_config_service_aws_v1_aws_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use AWSClient.ProtoReflect.Descriptor instead.
func (*AWSClient) Descriptor() ([]byte, []int) {
	return file_config_service_aws_v1_aws_proto_rawDescGZIP(), []int{1}
}

func (x *AWSClient) GetRetries() uint32 {
	if x != nil {
		return x.Retries
	}
	return 0
...
var file_config_service_aws_v1_aws_proto_rawDesc = []byte{
	...
	0x74, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x74, 0x0a, 0x06, 0x43, 0x6f, 0x6e, 0x66,
	...
	,
	...
	0x69, 0x63, 0x65, 0x2f, 0x61, 0x77, 0x73, 0x2f, 0x76, 0x31, 0x3b, 0x61, 0x77, 0x73, 0x76, 0x31,
...
var file_config_service_aws_v1_aws_proto_goTypes = []interface{}{
	...
	(*AWSClient)(nil), // 1: clutch.config.service.aws.v1.AWSClient
}
var file_config_service_aws_v1_aws_proto_depIdxs = []int32{
	1, // 0: clutch.config.service.aws.v1.Config.aws_client:type_name -> clutch.config.service.aws.v1.AWSClient
