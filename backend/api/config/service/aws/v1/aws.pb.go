...
type Config struct {
	...
	// Defaults to "default"
	CurrentAccountAlias string        `protobuf:"bytes,4,opt,name=current_account_alias,json=currentAccountAlias,proto3" json:"current_account_alias,omitempty"`
...
func (x *Config) GetCurrentAccountAlias() string {
	if x != nil {
		return x.CurrentAccountAlias
	}
	return ""
}
...
var file_config_service_aws_v1_aws_proto_rawDesc = []byte{
	...
	0x32, 0x0a, 0x15, 0x63, 0x75, 0x72, 0x72, 0x65, 0x6e, 0x74, 0x5f, 0x61, 0x63, 0x63, 0x6f, 0x75,
	0x6e, 0x74, 0x5f, 0x61, 0x6c, 0x69, 0x61, 0x73, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x13,
	0x63, 0x75, 0x72, 0x72, 0x65, 0x6e, 0x74, 0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x41, 0x6c,
