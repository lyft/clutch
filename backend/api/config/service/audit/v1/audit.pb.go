...
type Config struct {
	...
	Service isConfig_Service `protobuf_oneof:"service"`
...
func (m *Config) GetService() isConfig_Service {
	if m != nil {
		return m.Service
	}
	return nil
...
func (x *Config) GetDbProvider() string {
	if x, ok := x.GetService().(*Config_DbProvider); ok {
		return x.DbProvider
	}
	return ""
}
...
func (x *Config) GetLocalAuditing() bool {
	if x, ok := x.GetService().(*Config_LocalAuditing); ok {
...
type isConfig_Service interface {
	isConfig_Service()
}
...
func (*Config_DbProvider) isConfig_Service() {}

func (*Config_LocalAuditing) isConfig_Service() {}
...
var file_config_service_audit_v1_audit_proto_rawDesc = []byte{
	...
	0x6c, 0x74, 0x65, 0x72, 0x22, 0xbe, 0x01, 0x0a, 0x06, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x12,
	...
	0x03, 0x28, 0x09, 0x52, 0x05, 0x73, 0x69, 0x6e, 0x6b, 0x73, 0x42, 0x09, 0x0a, 0x07, 0x73, 0x65,
	0x72, 0x76, 0x69, 0x63, 0x65, 0x42, 0x09, 0x5a, 0x07, 0x61, 0x75, 0x64, 0x69, 0x74, 0x76, 0x31,
