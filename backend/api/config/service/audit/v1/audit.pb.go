...
func (x *Config) GetLocalAuditing() bool {
	if x, ok := x.GetStorageProvider().(*Config_LocalAuditing); ok {
		return x.LocalAuditing
	}
	return false
}
...
type Config_LocalAuditing struct {
	// A flag to store audit messages in-memory before flushing to sinks.
	// This is not recommended for production environments.
	LocalAuditing bool `protobuf:"varint,2,opt,name=local_auditing,json=localAuditing,proto3,oneof"`
}

func (*Config_DbProvider) isConfig_StorageProvider() {}

func (*Config_LocalAuditing) isConfig_StorageProvider() {}
...
var file_config_service_audit_v1_audit_proto_rawDesc = []byte{
	...
	0x6c, 0x74, 0x65, 0x72, 0x22, 0xc7, 0x01, 0x0a, 0x06, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x12,
	...
	,
