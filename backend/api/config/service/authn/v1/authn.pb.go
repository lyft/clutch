...
type OIDC struct {
	...
	OverrideSubjectClaimName string   `protobuf:"bytes,6,opt,name=override_subject_claim_name,json=overrideSubjectClaimName,proto3" json:"override_subject_claim_name,omitempty"`
}
...
func (x *OIDC) GetOverrideSubjectClaimName() string {
	if x != nil {
		return x.OverrideSubjectClaimName
	}
	return ""
}
...
var file_config_service_authn_v1_authn_proto_rawDesc = []byte{
	...
	0x12, 0x3d, 0x0a, 0x1b, 0x6f, 0x76, 0x65, 0x72, 0x72, 0x69, 0x64, 0x65, 0x5f, 0x73, 0x75, 0x62,
	0x6a, 0x65, 0x63, 0x74, 0x5f, 0x63, 0x6c, 0x61, 0x69, 0x6d, 0x5f, 0x6e, 0x61, 0x6d, 0x65, 0x18,
	0x06, 0x20, 0x01, 0x28, 0x09, 0x52, 0x18, 0x6f, 0x76, 0x65, 0x72, 0x72, 0x69, 0x64, 0x65, 0x53,
	0x75, 0x62, 0x6a, 0x65, 0x63, 0x74, 0x43, 0x6c, 0x61, 0x69, 0x6d, 0x4e, 0x61, 0x6d, 0x65, 0x22,
