...
var file_k8s_v1_k8s_proto_rawDesc = []byte{
	...
	0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x62, 0x0a, 0x0e, 0x4e, 0x75, 0x6c,
	...
	0x74, 0x69, 0x6f, 0x6e, 0x73, 0x32, 0xe6, 0x07, 0x0a, 0x06, 0x4b, 0x38, 0x73, 0x41, 0x50, 0x49,
	...
	0x79, 0x6d, 0x65, 0x6e, 0x74, 0x3a, 0x01, 0x2a, 0xaa, 0xe1, 0x1c, 0x02, 0x08, 0x04, 0x42, 0x31,
...
var file_k8s_v1_k8s_proto_msgTypes = make([]protoimpl.MessageInfo, 42)
var file_k8s_v1_k8s_proto_goTypes = []interface{}{
	...
	(*NullableString)(nil),                 // 23: clutch.k8s.v1.NullableString
	(*ExpectedObjectMetaFields)(nil),       // 24: clutch.k8s.v1.ExpectedObjectMetaFields
	(*ObjectMetaFields)(nil),               // 25: clutch.k8s.v1.ObjectMetaFields
	(*RemoveObjectMetaFields)(nil),         // 26: clutch.k8s.v1.RemoveObjectMetaFields
	nil,                                    // 27: clutch.k8s.v1.DescribePodRequest.LabelsEntry
	nil,                                    // 28: clutch.k8s.v1.Pod.LabelsEntry
	nil,                                    // 29: clutch.k8s.v1.Pod.AnnotationsEntry
	nil,                                    // 30: clutch.k8s.v1.ListOptions.LabelsEntry
	(*HPA_Sizing)(nil),                     // 31: clutch.k8s.v1.HPA.Sizing
	nil,                                    // 32: clutch.k8s.v1.HPA.LabelsEntry
	nil,                                    // 33: clutch.k8s.v1.HPA.AnnotationsEntry
	(*ResizeHPARequest_Sizing)(nil),        // 34: clutch.k8s.v1.ResizeHPARequest.Sizing
	nil,                                    // 35: clutch.k8s.v1.Deployment.LabelsEntry
	nil,                                    // 36: clutch.k8s.v1.Deployment.AnnotationsEntry
	(*UpdateDeploymentRequest_Fields)(nil), // 37: clutch.k8s.v1.UpdateDeploymentRequest.Fields
	nil,                                    // 38: clutch.k8s.v1.UpdateDeploymentRequest.Fields.LabelsEntry
	nil,                                    // 39: clutch.k8s.v1.UpdateDeploymentRequest.Fields.AnnotationsEntry
	nil,                                    // 40: clutch.k8s.v1.ExpectedObjectMetaFields.LabelsEntry
	nil,                                    // 41: clutch.k8s.v1.ExpectedObjectMetaFields.AnnotationsEntry
	nil,                                    // 42: clutch.k8s.v1.ObjectMetaFields.LabelsEntry
	nil,                                    // 43: clutch.k8s.v1.ObjectMetaFields.AnnotationsEntry
...
var file_k8s_v1_k8s_proto_depIdxs = []int32{
	27, // 0: clutch.k8s.v1.DescribePodRequest.labels:type_name -> clutch.k8s.v1.DescribePodRequest.LabelsEntry
	...
	44, // 5: clutch.k8s.v1.Pod.start_time:type_name -> google.protobuf.Timestamp
	28, // 6: clutch.k8s.v1.Pod.labels:type_name -> clutch.k8s.v1.Pod.LabelsEntry
	29, // 7: clutch.k8s.v1.Pod.annotations:type_name -> clutch.k8s.v1.Pod.AnnotationsEntry
	30, // 8: clutch.k8s.v1.ListOptions.labels:type_name -> clutch.k8s.v1.ListOptions.LabelsEntry
	...
	24, // 11: clutch.k8s.v1.UpdatePodRequest.expected_object_meta_fields:type_name -> clutch.k8s.v1.ExpectedObjectMetaFields
	25, // 12: clutch.k8s.v1.UpdatePodRequest.object_meta_fields:type_name -> clutch.k8s.v1.ObjectMetaFields
	26, // 13: clutch.k8s.v1.UpdatePodRequest.remove_object_meta_fields:type_name -> clutch.k8s.v1.RemoveObjectMetaFields
	31, // 14: clutch.k8s.v1.HPA.sizing:type_name -> clutch.k8s.v1.HPA.Sizing
	32, // 15: clutch.k8s.v1.HPA.labels:type_name -> clutch.k8s.v1.HPA.LabelsEntry
	33, // 16: clutch.k8s.v1.HPA.annotations:type_name -> clutch.k8s.v1.HPA.AnnotationsEntry
	34, // 17: clutch.k8s.v1.ResizeHPARequest.sizing:type_name -> clutch.k8s.v1.ResizeHPARequest.Sizing
	35, // 18: clutch.k8s.v1.Deployment.labels:type_name -> clutch.k8s.v1.Deployment.LabelsEntry
	36, // 19: clutch.k8s.v1.Deployment.annotations:type_name -> clutch.k8s.v1.Deployment.AnnotationsEntry
	37, // 20: clutch.k8s.v1.UpdateDeploymentRequest.fields:type_name -> clutch.k8s.v1.UpdateDeploymentRequest.Fields
	45, // 21: clutch.k8s.v1.NullableString.null:type_name -> google.protobuf.NullValue
	40, // 22: clutch.k8s.v1.ExpectedObjectMetaFields.labels:type_name -> clutch.k8s.v1.ExpectedObjectMetaFields.LabelsEntry
	41, // 23: clutch.k8s.v1.ExpectedObjectMetaFields.annotations:type_name -> clutch.k8s.v1.ExpectedObjectMetaFields.AnnotationsEntry
	42, // 24: clutch.k8s.v1.ObjectMetaFields.labels:type_name -> clutch.k8s.v1.ObjectMetaFields.LabelsEntry
	43, // 25: clutch.k8s.v1.ObjectMetaFields.annotations:type_name -> clutch.k8s.v1.ObjectMetaFields.AnnotationsEntry
	38, // 26: clutch.k8s.v1.UpdateDeploymentRequest.Fields.labels:type_name -> clutch.k8s.v1.UpdateDeploymentRequest.Fields.LabelsEntry
	39, // 27: clutch.k8s.v1.UpdateDeploymentRequest.Fields.annotations:type_name -> clutch.k8s.v1.UpdateDeploymentRequest.Fields.AnnotationsEntry
	23, // 28: clutch.k8s.v1.ExpectedObjectMetaFields.LabelsEntry.value:type_name -> clutch.k8s.v1.NullableString
	23, // 29: clutch.k8s.v1.ExpectedObjectMetaFields.AnnotationsEntry.value:type_name -> clutch.k8s.v1.NullableString
	...
	16, // 35: clutch.k8s.v1.K8sAPI.DeleteHPA:input_type -> clutch.k8s.v1.DeleteHPARequest
	19, // 36: clutch.k8s.v1.K8sAPI.UpdateDeployment:input_type -> clutch.k8s.v1.UpdateDeploymentRequest
	21, // 37: clutch.k8s.v1.K8sAPI.DeleteDeployment:input_type -> clutch.k8s.v1.DeleteDeploymentRequest
	3,  // 38: clutch.k8s.v1.K8sAPI.DescribePod:output_type -> clutch.k8s.v1.DescribePodResponse
	8,  // 39: clutch.k8s.v1.K8sAPI.ListPods:output_type -> clutch.k8s.v1.ListPodsResponse
	10, // 40: clutch.k8s.v1.K8sAPI.DeletePod:output_type -> clutch.k8s.v1.DeletePodResponse
	12, // 41: clutch.k8s.v1.K8sAPI.UpdatePod:output_type -> clutch.k8s.v1.UpdatePodResponse
	15, // 42: clutch.k8s.v1.K8sAPI.ResizeHPA:output_type -> clutch.k8s.v1.ResizeHPAResponse
	17, // 43: clutch.k8s.v1.K8sAPI.DeleteHPA:output_type -> clutch.k8s.v1.DeleteHPAResponse
	20, // 44: clutch.k8s.v1.K8sAPI.UpdateDeployment:output_type -> clutch.k8s.v1.UpdateDeploymentResponse
	22, // 45: clutch.k8s.v1.K8sAPI.DeleteDeployment:output_type -> clutch.k8s.v1.DeleteDeploymentResponse
...
func file_k8s_v1_k8s_proto_init() {
	...
	file_k8s_v1_k8s_proto_msgTypes[21].OneofWrappers = []interface{}{
