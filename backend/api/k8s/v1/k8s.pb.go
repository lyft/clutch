...
var file_k8s_v1_k8s_proto_rawDesc = []byte{
	...
	0x7b, 0x6e, 0x61, 0x6d, 0x65, 0x7d, 0x22, 0x88, 0x01, 0x0a, 0x0b, 0x4c, 0x69, 0x73, 0x74, 0x4f,
	0x70, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x12, 0x3e, 0x0a, 0x06, 0x6c, 0x61, 0x62, 0x65, 0x6c, 0x73,
	0x18, 0x09, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x26, 0x2e, 0x63, 0x6c, 0x75, 0x74, 0x63, 0x68, 0x2e,
	...
	0x28, 0x09, 0x52, 0x03, 0x6b, 0x65, 0x79, 0x12, 0x14, 0x0a, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65,
	0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38,
	0x01, 0x22, 0xb9, 0x01, 0x0a, 0x0f, 0x4c, 0x69, 0x73, 0x74, 0x50, 0x6f, 0x64, 0x73, 0x52, 0x65,
	...
	0x01, 0x52, 0x09, 0x63, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x73, 0x65, 0x74, 0x12, 0x18, 0x0a, 0x07,
	...
	0x50, 0x41, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0xa0, 0x03, 0x0a, 0x0a, 0x44,
	...
	0x73, 0x70, 0x61, 0x63, 0x65, 0x7d, 0x2f, 0x7b, 0x6e, 0x61, 0x6d, 0x65, 0x7d, 0x22, 0x8f, 0x05,
	...
	0x65, 0x6e, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x96, 0x03, 0x0a, 0x18,
	...
	0x52, 0x0b, 0x61, 0x6e, 0x6e, 0x6f, 0x74, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x1a, 0x57, 0x0a,
	0x0b, 0x4c, 0x61, 0x62, 0x65, 0x6c, 0x73, 0x45, 0x6e, 0x74, 0x72, 0x79, 0x12, 0x10, 0x0a, 0x03,
	...
	0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x1a, 0x5c, 0x0a, 0x10, 0x41, 0x6e, 0x6e, 0x6f, 0x74, 0x61,
	...
	0x73, 0x32, 0xe1, 0x05, 0x0a, 0x06, 0x4b, 0x38, 0x73, 0x41, 0x50, 0x49, 0x12, 0x7a, 0x0a, 0x0b,
	...
	0x1c, 0x02, 0x08, 0x03, 0x12, 0x8e, 0x01, 0x0a, 0x10, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x44,
	...
	0xe1, 0x1c, 0x02, 0x08, 0x03, 0x42, 0x07, 0x5a, 0x05, 0x6b, 0x38, 0x73, 0x76, 0x31, 0x62, 0x06,
...
var file_k8s_v1_k8s_proto_msgTypes = make([]protoimpl.MessageInfo, 37)
var file_k8s_v1_k8s_proto_goTypes = []interface{}{
	...
	(*ExpectedObjectMetaFields)(nil),       // 19: clutch.k8s.v1.ExpectedObjectMetaFields
	(*ObjectMetaFields)(nil),               // 20: clutch.k8s.v1.ObjectMetaFields
	(*RemoveObjectMetaFields)(nil),         // 21: clutch.k8s.v1.RemoveObjectMetaFields
	nil,                                    // 22: clutch.k8s.v1.DescribePodRequest.LabelsEntry
	nil,                                    // 23: clutch.k8s.v1.Pod.LabelsEntry
	nil,                                    // 24: clutch.k8s.v1.Pod.AnnotationsEntry
	nil,                                    // 25: clutch.k8s.v1.ListOptions.LabelsEntry
	(*HPA_Sizing)(nil),                     // 26: clutch.k8s.v1.HPA.Sizing
	nil,                                    // 27: clutch.k8s.v1.HPA.LabelsEntry
	nil,                                    // 28: clutch.k8s.v1.HPA.AnnotationsEntry
	(*ResizeHPARequest_Sizing)(nil),        // 29: clutch.k8s.v1.ResizeHPARequest.Sizing
	nil,                                    // 30: clutch.k8s.v1.Deployment.LabelsEntry
	nil,                                    // 31: clutch.k8s.v1.Deployment.AnnotationsEntry
	(*UpdateDeploymentRequest_Fields)(nil), // 32: clutch.k8s.v1.UpdateDeploymentRequest.Fields
	nil,                                    // 33: clutch.k8s.v1.UpdateDeploymentRequest.Fields.LabelsEntry
	nil,                                    // 34: clutch.k8s.v1.UpdateDeploymentRequest.Fields.AnnotationsEntry
	nil,                                    // 35: clutch.k8s.v1.ExpectedObjectMetaFields.LabelsEntry
	nil,                                    // 36: clutch.k8s.v1.ExpectedObjectMetaFields.AnnotationsEntry
	nil,                                    // 37: clutch.k8s.v1.ObjectMetaFields.LabelsEntry
	nil,                                    // 38: clutch.k8s.v1.ObjectMetaFields.AnnotationsEntry
...
var file_k8s_v1_k8s_proto_depIdxs = []int32{
	22, // 0: clutch.k8s.v1.DescribePodRequest.labels:type_name -> clutch.k8s.v1.DescribePodRequest.LabelsEntry
	...
	39, // 5: clutch.k8s.v1.Pod.start_time:type_name -> google.protobuf.Timestamp
	23, // 6: clutch.k8s.v1.Pod.labels:type_name -> clutch.k8s.v1.Pod.LabelsEntry
	24, // 7: clutch.k8s.v1.Pod.annotations:type_name -> clutch.k8s.v1.Pod.AnnotationsEntry
	25, // 8: clutch.k8s.v1.ListOptions.labels:type_name -> clutch.k8s.v1.ListOptions.LabelsEntry
	...
	19, // 11: clutch.k8s.v1.UpdatePodRequest.expected_object_meta_fields:type_name -> clutch.k8s.v1.ExpectedObjectMetaFields
	20, // 12: clutch.k8s.v1.UpdatePodRequest.object_meta_fields:type_name -> clutch.k8s.v1.ObjectMetaFields
	21, // 13: clutch.k8s.v1.UpdatePodRequest.remove_object_meta_fields:type_name -> clutch.k8s.v1.RemoveObjectMetaFields
	26, // 14: clutch.k8s.v1.HPA.sizing:type_name -> clutch.k8s.v1.HPA.Sizing
	27, // 15: clutch.k8s.v1.HPA.labels:type_name -> clutch.k8s.v1.HPA.LabelsEntry
	28, // 16: clutch.k8s.v1.HPA.annotations:type_name -> clutch.k8s.v1.HPA.AnnotationsEntry
	29, // 17: clutch.k8s.v1.ResizeHPARequest.sizing:type_name -> clutch.k8s.v1.ResizeHPARequest.Sizing
	30, // 18: clutch.k8s.v1.Deployment.labels:type_name -> clutch.k8s.v1.Deployment.LabelsEntry
	31, // 19: clutch.k8s.v1.Deployment.annotations:type_name -> clutch.k8s.v1.Deployment.AnnotationsEntry
	32, // 20: clutch.k8s.v1.UpdateDeploymentRequest.fields:type_name -> clutch.k8s.v1.UpdateDeploymentRequest.Fields
	35, // 21: clutch.k8s.v1.ExpectedObjectMetaFields.labels:type_name -> clutch.k8s.v1.ExpectedObjectMetaFields.LabelsEntry
	36, // 22: clutch.k8s.v1.ExpectedObjectMetaFields.annotations:type_name -> clutch.k8s.v1.ExpectedObjectMetaFields.AnnotationsEntry
	37, // 23: clutch.k8s.v1.ObjectMetaFields.labels:type_name -> clutch.k8s.v1.ObjectMetaFields.LabelsEntry
	38, // 24: clutch.k8s.v1.ObjectMetaFields.annotations:type_name -> clutch.k8s.v1.ObjectMetaFields.AnnotationsEntry
	33, // 25: clutch.k8s.v1.UpdateDeploymentRequest.Fields.labels:type_name -> clutch.k8s.v1.UpdateDeploymentRequest.Fields.LabelsEntry
	34, // 26: clutch.k8s.v1.UpdateDeploymentRequest.Fields.annotations:type_name -> clutch.k8s.v1.UpdateDeploymentRequest.Fields.AnnotationsEntry
	40, // 27: clutch.k8s.v1.ExpectedObjectMetaFields.LabelsEntry.value:type_name -> google.protobuf.StringValue
	40, // 28: clutch.k8s.v1.ExpectedObjectMetaFields.AnnotationsEntry.value:type_name -> google.protobuf.StringValue
	2,  // 29: clutch.k8s.v1.K8sAPI.DescribePod:input_type -> clutch.k8s.v1.DescribePodRequest
	7,  // 30: clutch.k8s.v1.K8sAPI.ListPods:input_type -> clutch.k8s.v1.ListPodsRequest
	9,  // 31: clutch.k8s.v1.K8sAPI.DeletePod:input_type -> clutch.k8s.v1.DeletePodRequest
	11, // 32: clutch.k8s.v1.K8sAPI.UpdatePod:input_type -> clutch.k8s.v1.UpdatePodRequest
	14, // 33: clutch.k8s.v1.K8sAPI.ResizeHPA:input_type -> clutch.k8s.v1.ResizeHPARequest
	17, // 34: clutch.k8s.v1.K8sAPI.UpdateDeployment:input_type -> clutch.k8s.v1.UpdateDeploymentRequest
	3,  // 35: clutch.k8s.v1.K8sAPI.DescribePod:output_type -> clutch.k8s.v1.DescribePodResponse
	8,  // 36: clutch.k8s.v1.K8sAPI.ListPods:output_type -> clutch.k8s.v1.ListPodsResponse
	10, // 37: clutch.k8s.v1.K8sAPI.DeletePod:output_type -> clutch.k8s.v1.DeletePodResponse
	12, // 38: clutch.k8s.v1.K8sAPI.UpdatePod:output_type -> clutch.k8s.v1.UpdatePodResponse
	15, // 39: clutch.k8s.v1.K8sAPI.ResizeHPA:output_type -> clutch.k8s.v1.ResizeHPAResponse
	18, // 40: clutch.k8s.v1.K8sAPI.UpdateDeployment:output_type -> clutch.k8s.v1.UpdateDeploymentResponse
