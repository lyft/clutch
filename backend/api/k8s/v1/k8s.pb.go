...
var file_k8s_v1_k8s_proto_rawDesc = []byte{
	...
	0x73, 0x32, 0xfc, 0x12, 0x0a, 0x06, 0x4b, 0x38, 0x73, 0x41, 0x50, 0x49, 0x12, 0x7a, 0x0a, 0x0b,
	...
	0x01, 0x2a, 0xaa, 0xe1, 0x1c, 0x02, 0x08, 0x04, 0x12, 0x8e, 0x01, 0x0a, 0x10, 0x55, 0x70, 0x64,
...
var file_k8s_v1_k8s_proto_msgTypes = make([]protoimpl.MessageInfo, 82)
var file_k8s_v1_k8s_proto_goTypes = []interface{}{
	...
	(*NullableString)(nil),                  // 48: clutch.k8s.v1.NullableString
	(*ExpectedObjectMetaFields)(nil),        // 49: clutch.k8s.v1.ExpectedObjectMetaFields
	(*ObjectMetaFields)(nil),                // 50: clutch.k8s.v1.ObjectMetaFields
	(*RemoveObjectMetaFields)(nil),          // 51: clutch.k8s.v1.RemoveObjectMetaFields
	nil,                                     // 52: clutch.k8s.v1.DescribePodRequest.LabelsEntry
	nil,                                     // 53: clutch.k8s.v1.Pod.LabelsEntry
	nil,                                     // 54: clutch.k8s.v1.Pod.AnnotationsEntry
	nil,                                     // 55: clutch.k8s.v1.ListOptions.LabelsEntry
	(*HPA_Sizing)(nil),                      // 56: clutch.k8s.v1.HPA.Sizing
	nil,                                     // 57: clutch.k8s.v1.HPA.LabelsEntry
	nil,                                     // 58: clutch.k8s.v1.HPA.AnnotationsEntry
	(*ResizeHPARequest_Sizing)(nil),         // 59: clutch.k8s.v1.ResizeHPARequest.Sizing
	nil,                                     // 60: clutch.k8s.v1.Deployment.LabelsEntry
	nil,                                     // 61: clutch.k8s.v1.Deployment.AnnotationsEntry
	(*UpdateDeploymentRequest_Fields)(nil),  // 62: clutch.k8s.v1.UpdateDeploymentRequest.Fields
	nil,                                     // 63: clutch.k8s.v1.UpdateDeploymentRequest.Fields.LabelsEntry
	nil,                                     // 64: clutch.k8s.v1.UpdateDeploymentRequest.Fields.AnnotationsEntry
	nil,                                     // 65: clutch.k8s.v1.StatefulSet.LabelsEntry
	nil,                                     // 66: clutch.k8s.v1.StatefulSet.AnnotationsEntry
	nil,                                     // 67: clutch.k8s.v1.DescribeStatefulSetRequest.LabelsEntry
	(*UpdateStatefulSetRequest_Fields)(nil), // 68: clutch.k8s.v1.UpdateStatefulSetRequest.Fields
	nil,                                     // 69: clutch.k8s.v1.UpdateStatefulSetRequest.Fields.LabelsEntry
	nil,                                     // 70: clutch.k8s.v1.UpdateStatefulSetRequest.Fields.AnnotationsEntry
	nil,                                     // 71: clutch.k8s.v1.Service.LabelsEntry
	nil,                                     // 72: clutch.k8s.v1.Service.AnnotationsEntry
	nil,                                     // 73: clutch.k8s.v1.DescribeServiceRequest.LabelsEntry
	nil,                                     // 74: clutch.k8s.v1.CronJob.LabelsEntry
	nil,                                     // 75: clutch.k8s.v1.CronJob.AnnotationsEntry
	nil,                                     // 76: clutch.k8s.v1.DescribeCronJobRequest.LabelsEntry
	nil,                                     // 77: clutch.k8s.v1.ConfigMap.AnnotationsEntry
	nil,                                     // 78: clutch.k8s.v1.ConfigMap.LabelsEntry
	nil,                                     // 79: clutch.k8s.v1.DescribeConfigMapRequest.LabelsEntry
	nil,                                     // 80: clutch.k8s.v1.DescribeConfigMapRequest.AnnotationsEntry
	nil,                                     // 81: clutch.k8s.v1.ExpectedObjectMetaFields.LabelsEntry
	nil,                                     // 82: clutch.k8s.v1.ExpectedObjectMetaFields.AnnotationsEntry
	nil,                                     // 83: clutch.k8s.v1.ObjectMetaFields.LabelsEntry
	nil,                                     // 84: clutch.k8s.v1.ObjectMetaFields.AnnotationsEntry
	(*timestamp.Timestamp)(nil),             // 85: google.protobuf.Timestamp
	(_struct.NullValue)(0),                  // 86: google.protobuf.NullValue
}
var file_k8s_v1_k8s_proto_depIdxs = []int32{
	52, // 0: clutch.k8s.v1.DescribePodRequest.labels:type_name -> clutch.k8s.v1.DescribePodRequest.LabelsEntry
	...
	85, // 5: clutch.k8s.v1.Pod.start_time:type_name -> google.protobuf.Timestamp
	53, // 6: clutch.k8s.v1.Pod.labels:type_name -> clutch.k8s.v1.Pod.LabelsEntry
	54, // 7: clutch.k8s.v1.Pod.annotations:type_name -> clutch.k8s.v1.Pod.AnnotationsEntry
	55, // 8: clutch.k8s.v1.ListOptions.labels:type_name -> clutch.k8s.v1.ListOptions.LabelsEntry
	...
	49, // 11: clutch.k8s.v1.UpdatePodRequest.expected_object_meta_fields:type_name -> clutch.k8s.v1.ExpectedObjectMetaFields
	50, // 12: clutch.k8s.v1.UpdatePodRequest.object_meta_fields:type_name -> clutch.k8s.v1.ObjectMetaFields
	51, // 13: clutch.k8s.v1.UpdatePodRequest.remove_object_meta_fields:type_name -> clutch.k8s.v1.RemoveObjectMetaFields
	56, // 14: clutch.k8s.v1.HPA.sizing:type_name -> clutch.k8s.v1.HPA.Sizing
	57, // 15: clutch.k8s.v1.HPA.labels:type_name -> clutch.k8s.v1.HPA.LabelsEntry
	58, // 16: clutch.k8s.v1.HPA.annotations:type_name -> clutch.k8s.v1.HPA.AnnotationsEntry
	59, // 17: clutch.k8s.v1.ResizeHPARequest.sizing:type_name -> clutch.k8s.v1.ResizeHPARequest.Sizing
	60, // 18: clutch.k8s.v1.Deployment.labels:type_name -> clutch.k8s.v1.Deployment.LabelsEntry
	61, // 19: clutch.k8s.v1.Deployment.annotations:type_name -> clutch.k8s.v1.Deployment.AnnotationsEntry
	62, // 20: clutch.k8s.v1.UpdateDeploymentRequest.fields:type_name -> clutch.k8s.v1.UpdateDeploymentRequest.Fields
	65, // 21: clutch.k8s.v1.StatefulSet.labels:type_name -> clutch.k8s.v1.StatefulSet.LabelsEntry
	66, // 22: clutch.k8s.v1.StatefulSet.annotations:type_name -> clutch.k8s.v1.StatefulSet.AnnotationsEntry
	67, // 23: clutch.k8s.v1.DescribeStatefulSetRequest.labels:type_name -> clutch.k8s.v1.DescribeStatefulSetRequest.LabelsEntry
	68, // 24: clutch.k8s.v1.UpdateStatefulSetRequest.fields:type_name -> clutch.k8s.v1.UpdateStatefulSetRequest.Fields
	...
	71, // 27: clutch.k8s.v1.Service.labels:type_name -> clutch.k8s.v1.Service.LabelsEntry
	72, // 28: clutch.k8s.v1.Service.annotations:type_name -> clutch.k8s.v1.Service.AnnotationsEntry
	73, // 29: clutch.k8s.v1.DescribeServiceRequest.labels:type_name -> clutch.k8s.v1.DescribeServiceRequest.LabelsEntry
	31, // 30: clutch.k8s.v1.DescribeServiceResponse.service:type_name -> clutch.k8s.v1.Service
	74, // 31: clutch.k8s.v1.CronJob.labels:type_name -> clutch.k8s.v1.CronJob.LabelsEntry
	75, // 32: clutch.k8s.v1.CronJob.annotations:type_name -> clutch.k8s.v1.CronJob.AnnotationsEntry
	76, // 33: clutch.k8s.v1.DescribeCronJobRequest.labels:type_name -> clutch.k8s.v1.DescribeCronJobRequest.LabelsEntry
	36, // 34: clutch.k8s.v1.DescribeCronJobResponse.cronjob:type_name -> clutch.k8s.v1.CronJob
	77, // 35: clutch.k8s.v1.ConfigMap.annotations:type_name -> clutch.k8s.v1.ConfigMap.AnnotationsEntry
	78, // 36: clutch.k8s.v1.ConfigMap.labels:type_name -> clutch.k8s.v1.ConfigMap.LabelsEntry
	...
	79, // 39: clutch.k8s.v1.DescribeConfigMapRequest.labels:type_name -> clutch.k8s.v1.DescribeConfigMapRequest.LabelsEntry
	80, // 40: clutch.k8s.v1.DescribeConfigMapRequest.annotations:type_name -> clutch.k8s.v1.DescribeConfigMapRequest.AnnotationsEntry
	41, // 41: clutch.k8s.v1.DescribeConfigMapResponse.config_map:type_name -> clutch.k8s.v1.ConfigMap
	86, // 42: clutch.k8s.v1.NullableString.null:type_name -> google.protobuf.NullValue
	81, // 43: clutch.k8s.v1.ExpectedObjectMetaFields.labels:type_name -> clutch.k8s.v1.ExpectedObjectMetaFields.LabelsEntry
	82, // 44: clutch.k8s.v1.ExpectedObjectMetaFields.annotations:type_name -> clutch.k8s.v1.ExpectedObjectMetaFields.AnnotationsEntry
	83, // 45: clutch.k8s.v1.ObjectMetaFields.labels:type_name -> clutch.k8s.v1.ObjectMetaFields.LabelsEntry
	84, // 46: clutch.k8s.v1.ObjectMetaFields.annotations:type_name -> clutch.k8s.v1.ObjectMetaFields.AnnotationsEntry
	63, // 47: clutch.k8s.v1.UpdateDeploymentRequest.Fields.labels:type_name -> clutch.k8s.v1.UpdateDeploymentRequest.Fields.LabelsEntry
	64, // 48: clutch.k8s.v1.UpdateDeploymentRequest.Fields.annotations:type_name -> clutch.k8s.v1.UpdateDeploymentRequest.Fields.AnnotationsEntry
	69, // 49: clutch.k8s.v1.UpdateStatefulSetRequest.Fields.labels:type_name -> clutch.k8s.v1.UpdateStatefulSetRequest.Fields.LabelsEntry
	70, // 50: clutch.k8s.v1.UpdateStatefulSetRequest.Fields.annotations:type_name -> clutch.k8s.v1.UpdateStatefulSetRequest.Fields.AnnotationsEntry
	48, // 51: clutch.k8s.v1.ExpectedObjectMetaFields.LabelsEntry.value:type_name -> clutch.k8s.v1.NullableString
	48, // 52: clutch.k8s.v1.ExpectedObjectMetaFields.AnnotationsEntry.value:type_name -> clutch.k8s.v1.NullableString
	3,  // 53: clutch.k8s.v1.K8sAPI.DescribePod:input_type -> clutch.k8s.v1.DescribePodRequest
	8,  // 54: clutch.k8s.v1.K8sAPI.ListPods:input_type -> clutch.k8s.v1.ListPodsRequest
	10, // 55: clutch.k8s.v1.K8sAPI.DeletePod:input_type -> clutch.k8s.v1.DeletePodRequest
	12, // 56: clutch.k8s.v1.K8sAPI.UpdatePod:input_type -> clutch.k8s.v1.UpdatePodRequest
	15, // 57: clutch.k8s.v1.K8sAPI.ResizeHPA:input_type -> clutch.k8s.v1.ResizeHPARequest
	17, // 58: clutch.k8s.v1.K8sAPI.DeleteHPA:input_type -> clutch.k8s.v1.DeleteHPARequest
	20, // 59: clutch.k8s.v1.K8sAPI.UpdateDeployment:input_type -> clutch.k8s.v1.UpdateDeploymentRequest
	22, // 60: clutch.k8s.v1.K8sAPI.DeleteDeployment:input_type -> clutch.k8s.v1.DeleteDeploymentRequest
	32, // 61: clutch.k8s.v1.K8sAPI.DescribeService:input_type -> clutch.k8s.v1.DescribeServiceRequest
	34, // 62: clutch.k8s.v1.K8sAPI.DeleteService:input_type -> clutch.k8s.v1.DeleteServiceRequest
	25, // 63: clutch.k8s.v1.K8sAPI.DescribeStatefulSet:input_type -> clutch.k8s.v1.DescribeStatefulSetRequest
	27, // 64: clutch.k8s.v1.K8sAPI.UpdateStatefulSet:input_type -> clutch.k8s.v1.UpdateStatefulSetRequest
	26, // 65: clutch.k8s.v1.K8sAPI.DeleteStatefulSet:input_type -> clutch.k8s.v1.DeleteStatefulSetRequest
	37, // 66: clutch.k8s.v1.K8sAPI.DescribeCronJob:input_type -> clutch.k8s.v1.DescribeCronJobRequest
	39, // 67: clutch.k8s.v1.K8sAPI.DeleteCronJob:input_type -> clutch.k8s.v1.DeleteCronJobRequest
	42, // 68: clutch.k8s.v1.K8sAPI.ListConfigMaps:input_type -> clutch.k8s.v1.ListConfigMapsRequest
	44, // 69: clutch.k8s.v1.K8sAPI.DescribeConfigMap:input_type -> clutch.k8s.v1.DescribeConfigMapRequest
	46, // 70: clutch.k8s.v1.K8sAPI.DeleteConfigMap:input_type -> clutch.k8s.v1.DeleteConfigMapRequest
	4,  // 71: clutch.k8s.v1.K8sAPI.DescribePod:output_type -> clutch.k8s.v1.DescribePodResponse
	9,  // 72: clutch.k8s.v1.K8sAPI.ListPods:output_type -> clutch.k8s.v1.ListPodsResponse
	11, // 73: clutch.k8s.v1.K8sAPI.DeletePod:output_type -> clutch.k8s.v1.DeletePodResponse
	13, // 74: clutch.k8s.v1.K8sAPI.UpdatePod:output_type -> clutch.k8s.v1.UpdatePodResponse
	16, // 75: clutch.k8s.v1.K8sAPI.ResizeHPA:output_type -> clutch.k8s.v1.ResizeHPAResponse
	18, // 76: clutch.k8s.v1.K8sAPI.DeleteHPA:output_type -> clutch.k8s.v1.DeleteHPAResponse
	21, // 77: clutch.k8s.v1.K8sAPI.UpdateDeployment:output_type -> clutch.k8s.v1.UpdateDeploymentResponse
	23, // 78: clutch.k8s.v1.K8sAPI.DeleteDeployment:output_type -> clutch.k8s.v1.DeleteDeploymentResponse
	33, // 79: clutch.k8s.v1.K8sAPI.DescribeService:output_type -> clutch.k8s.v1.DescribeServiceResponse
	35, // 80: clutch.k8s.v1.K8sAPI.DeleteService:output_type -> clutch.k8s.v1.DeleteServiceResponse
	28, // 81: clutch.k8s.v1.K8sAPI.DescribeStatefulSet:output_type -> clutch.k8s.v1.DescribeStatefulSetResponse
	30, // 82: clutch.k8s.v1.K8sAPI.UpdateStatefulSet:output_type -> clutch.k8s.v1.UpdateStatefulSetResponse
	29, // 83: clutch.k8s.v1.K8sAPI.DeleteStatefulSet:output_type -> clutch.k8s.v1.DeleteStatefulSetResponse
	38, // 84: clutch.k8s.v1.K8sAPI.DescribeCronJob:output_type -> clutch.k8s.v1.DescribeCronJobResponse
	40, // 85: clutch.k8s.v1.K8sAPI.DeleteCronJob:output_type -> clutch.k8s.v1.DeleteCronJobResponse
	43, // 86: clutch.k8s.v1.K8sAPI.ListConfigMaps:output_type -> clutch.k8s.v1.ListConfigMapsResponse
	45, // 87: clutch.k8s.v1.K8sAPI.DescribeConfigMap:output_type -> clutch.k8s.v1.DescribeConfigMapResponse
	47, // 88: clutch.k8s.v1.K8sAPI.DeleteConfigMap:output_type -> clutch.k8s.v1.DeleteConfigMapResponse
...
func file_k8s_v1_k8s_proto_init() {
	...
	file_k8s_v1_k8s_proto_msgTypes[45].OneofWrappers = []interface{}{
