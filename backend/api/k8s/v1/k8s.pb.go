...
var file_k8s_v1_k8s_proto_rawDesc = []byte{
	...
	0x63, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x62, 0x0a, 0x0e, 0x4e, 0x75,
	...
	0x61, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x32, 0x8d, 0x0b, 0x0a, 0x06, 0x4b, 0x38, 0x73, 0x41, 0x50,
	...
	0xaa, 0xe1, 0x1c, 0x02, 0x08, 0x03, 0x42, 0x31, 0x5a, 0x2f, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62,
...
var file_k8s_v1_k8s_proto_msgTypes = make([]protoimpl.MessageInfo, 58)
var file_k8s_v1_k8s_proto_goTypes = []interface{}{
	...
	(*NullableString)(nil),                  // 32: clutch.k8s.v1.NullableString
	(*ExpectedObjectMetaFields)(nil),        // 33: clutch.k8s.v1.ExpectedObjectMetaFields
	(*ObjectMetaFields)(nil),                // 34: clutch.k8s.v1.ObjectMetaFields
	(*RemoveObjectMetaFields)(nil),          // 35: clutch.k8s.v1.RemoveObjectMetaFields
	nil,                                     // 36: clutch.k8s.v1.DescribePodRequest.LabelsEntry
	nil,                                     // 37: clutch.k8s.v1.Pod.LabelsEntry
	nil,                                     // 38: clutch.k8s.v1.Pod.AnnotationsEntry
	nil,                                     // 39: clutch.k8s.v1.ListOptions.LabelsEntry
	(*HPA_Sizing)(nil),                      // 40: clutch.k8s.v1.HPA.Sizing
	nil,                                     // 41: clutch.k8s.v1.HPA.LabelsEntry
	nil,                                     // 42: clutch.k8s.v1.HPA.AnnotationsEntry
	(*ResizeHPARequest_Sizing)(nil),         // 43: clutch.k8s.v1.ResizeHPARequest.Sizing
	nil,                                     // 44: clutch.k8s.v1.Deployment.LabelsEntry
	nil,                                     // 45: clutch.k8s.v1.Deployment.AnnotationsEntry
	(*UpdateDeploymentRequest_Fields)(nil),  // 46: clutch.k8s.v1.UpdateDeploymentRequest.Fields
	nil,                                     // 47: clutch.k8s.v1.UpdateDeploymentRequest.Fields.LabelsEntry
	nil,                                     // 48: clutch.k8s.v1.UpdateDeploymentRequest.Fields.AnnotationsEntry
	nil,                                     // 49: clutch.k8s.v1.StatefulSet.LabelsEntry
	nil,                                     // 50: clutch.k8s.v1.StatefulSet.AnnotationsEntry
	(*UpdateStatefulSetRequest_Fields)(nil), // 51: clutch.k8s.v1.UpdateStatefulSetRequest.Fields
	nil,                                     // 52: clutch.k8s.v1.UpdateStatefulSetRequest.Fields.LabelsEntry
	nil,                                     // 53: clutch.k8s.v1.UpdateStatefulSetRequest.Fields.AnnotationsEntry
	nil,                                     // 54: clutch.k8s.v1.Service.LabelsEntry
	nil,                                     // 55: clutch.k8s.v1.Service.AnnotationsEntry
	nil,                                     // 56: clutch.k8s.v1.DescribeServiceRequest.LabelsEntry
	nil,                                     // 57: clutch.k8s.v1.ExpectedObjectMetaFields.LabelsEntry
	nil,                                     // 58: clutch.k8s.v1.ExpectedObjectMetaFields.AnnotationsEntry
	nil,                                     // 59: clutch.k8s.v1.ObjectMetaFields.LabelsEntry
	nil,                                     // 60: clutch.k8s.v1.ObjectMetaFields.AnnotationsEntry
	(*timestamp.Timestamp)(nil),             // 61: google.protobuf.Timestamp
	(_struct.NullValue)(0),                  // 62: google.protobuf.NullValue
}
var file_k8s_v1_k8s_proto_depIdxs = []int32{
	36, // 0: clutch.k8s.v1.DescribePodRequest.labels:type_name -> clutch.k8s.v1.DescribePodRequest.LabelsEntry
	...
	61, // 5: clutch.k8s.v1.Pod.start_time:type_name -> google.protobuf.Timestamp
	37, // 6: clutch.k8s.v1.Pod.labels:type_name -> clutch.k8s.v1.Pod.LabelsEntry
	38, // 7: clutch.k8s.v1.Pod.annotations:type_name -> clutch.k8s.v1.Pod.AnnotationsEntry
	39, // 8: clutch.k8s.v1.ListOptions.labels:type_name -> clutch.k8s.v1.ListOptions.LabelsEntry
	...
	33, // 11: clutch.k8s.v1.UpdatePodRequest.expected_object_meta_fields:type_name -> clutch.k8s.v1.ExpectedObjectMetaFields
	34, // 12: clutch.k8s.v1.UpdatePodRequest.object_meta_fields:type_name -> clutch.k8s.v1.ObjectMetaFields
	35, // 13: clutch.k8s.v1.UpdatePodRequest.remove_object_meta_fields:type_name -> clutch.k8s.v1.RemoveObjectMetaFields
	40, // 14: clutch.k8s.v1.HPA.sizing:type_name -> clutch.k8s.v1.HPA.Sizing
	41, // 15: clutch.k8s.v1.HPA.labels:type_name -> clutch.k8s.v1.HPA.LabelsEntry
	42, // 16: clutch.k8s.v1.HPA.annotations:type_name -> clutch.k8s.v1.HPA.AnnotationsEntry
	43, // 17: clutch.k8s.v1.ResizeHPARequest.sizing:type_name -> clutch.k8s.v1.ResizeHPARequest.Sizing
	44, // 18: clutch.k8s.v1.Deployment.labels:type_name -> clutch.k8s.v1.Deployment.LabelsEntry
	45, // 19: clutch.k8s.v1.Deployment.annotations:type_name -> clutch.k8s.v1.Deployment.AnnotationsEntry
	46, // 20: clutch.k8s.v1.UpdateDeploymentRequest.fields:type_name -> clutch.k8s.v1.UpdateDeploymentRequest.Fields
	49, // 21: clutch.k8s.v1.StatefulSet.labels:type_name -> clutch.k8s.v1.StatefulSet.LabelsEntry
	50, // 22: clutch.k8s.v1.StatefulSet.annotations:type_name -> clutch.k8s.v1.StatefulSet.AnnotationsEntry
	51, // 23: clutch.k8s.v1.UpdateStatefulSetRequest.fields:type_name -> clutch.k8s.v1.UpdateStatefulSetRequest.Fields
	2,  // 24: clutch.k8s.v1.Service.type:type_name -> clutch.k8s.v1.Service.Type
	54, // 25: clutch.k8s.v1.Service.labels:type_name -> clutch.k8s.v1.Service.LabelsEntry
	55, // 26: clutch.k8s.v1.Service.annotations:type_name -> clutch.k8s.v1.Service.AnnotationsEntry
	56, // 27: clutch.k8s.v1.DescribeServiceRequest.labels:type_name -> clutch.k8s.v1.DescribeServiceRequest.LabelsEntry
	27, // 28: clutch.k8s.v1.DescribeServiceResponse.service:type_name -> clutch.k8s.v1.Service
	62, // 29: clutch.k8s.v1.NullableString.null:type_name -> google.protobuf.NullValue
	57, // 30: clutch.k8s.v1.ExpectedObjectMetaFields.labels:type_name -> clutch.k8s.v1.ExpectedObjectMetaFields.LabelsEntry
	58, // 31: clutch.k8s.v1.ExpectedObjectMetaFields.annotations:type_name -> clutch.k8s.v1.ExpectedObjectMetaFields.AnnotationsEntry
	59, // 32: clutch.k8s.v1.ObjectMetaFields.labels:type_name -> clutch.k8s.v1.ObjectMetaFields.LabelsEntry
	60, // 33: clutch.k8s.v1.ObjectMetaFields.annotations:type_name -> clutch.k8s.v1.ObjectMetaFields.AnnotationsEntry
	47, // 34: clutch.k8s.v1.UpdateDeploymentRequest.Fields.labels:type_name -> clutch.k8s.v1.UpdateDeploymentRequest.Fields.LabelsEntry
	48, // 35: clutch.k8s.v1.UpdateDeploymentRequest.Fields.annotations:type_name -> clutch.k8s.v1.UpdateDeploymentRequest.Fields.AnnotationsEntry
	52, // 36: clutch.k8s.v1.UpdateStatefulSetRequest.Fields.labels:type_name -> clutch.k8s.v1.UpdateStatefulSetRequest.Fields.LabelsEntry
	53, // 37: clutch.k8s.v1.UpdateStatefulSetRequest.Fields.annotations:type_name -> clutch.k8s.v1.UpdateStatefulSetRequest.Fields.AnnotationsEntry
	32, // 38: clutch.k8s.v1.ExpectedObjectMetaFields.LabelsEntry.value:type_name -> clutch.k8s.v1.NullableString
	32, // 39: clutch.k8s.v1.ExpectedObjectMetaFields.AnnotationsEntry.value:type_name -> clutch.k8s.v1.NullableString
	3,  // 40: clutch.k8s.v1.K8sAPI.DescribePod:input_type -> clutch.k8s.v1.DescribePodRequest
	8,  // 41: clutch.k8s.v1.K8sAPI.ListPods:input_type -> clutch.k8s.v1.ListPodsRequest
	10, // 42: clutch.k8s.v1.K8sAPI.DeletePod:input_type -> clutch.k8s.v1.DeletePodRequest
	12, // 43: clutch.k8s.v1.K8sAPI.UpdatePod:input_type -> clutch.k8s.v1.UpdatePodRequest
	15, // 44: clutch.k8s.v1.K8sAPI.ResizeHPA:input_type -> clutch.k8s.v1.ResizeHPARequest
	17, // 45: clutch.k8s.v1.K8sAPI.DeleteHPA:input_type -> clutch.k8s.v1.DeleteHPARequest
	20, // 46: clutch.k8s.v1.K8sAPI.UpdateDeployment:input_type -> clutch.k8s.v1.UpdateDeploymentRequest
	22, // 47: clutch.k8s.v1.K8sAPI.DeleteDeployment:input_type -> clutch.k8s.v1.DeleteDeploymentRequest
	28, // 48: clutch.k8s.v1.K8sAPI.DescribeService:input_type -> clutch.k8s.v1.DescribeServiceRequest
	30, // 49: clutch.k8s.v1.K8sAPI.DeleteService:input_type -> clutch.k8s.v1.DeleteServiceRequest
	25, // 50: clutch.k8s.v1.K8sAPI.UpdateStatefulSet:input_type -> clutch.k8s.v1.UpdateStatefulSetRequest
	4,  // 51: clutch.k8s.v1.K8sAPI.DescribePod:output_type -> clutch.k8s.v1.DescribePodResponse
	9,  // 52: clutch.k8s.v1.K8sAPI.ListPods:output_type -> clutch.k8s.v1.ListPodsResponse
	11, // 53: clutch.k8s.v1.K8sAPI.DeletePod:output_type -> clutch.k8s.v1.DeletePodResponse
	13, // 54: clutch.k8s.v1.K8sAPI.UpdatePod:output_type -> clutch.k8s.v1.UpdatePodResponse
	16, // 55: clutch.k8s.v1.K8sAPI.ResizeHPA:output_type -> clutch.k8s.v1.ResizeHPAResponse
	18, // 56: clutch.k8s.v1.K8sAPI.DeleteHPA:output_type -> clutch.k8s.v1.DeleteHPAResponse
	21, // 57: clutch.k8s.v1.K8sAPI.UpdateDeployment:output_type -> clutch.k8s.v1.UpdateDeploymentResponse
	23, // 58: clutch.k8s.v1.K8sAPI.DeleteDeployment:output_type -> clutch.k8s.v1.DeleteDeploymentResponse
	29, // 59: clutch.k8s.v1.K8sAPI.DescribeService:output_type -> clutch.k8s.v1.DescribeServiceResponse
	31, // 60: clutch.k8s.v1.K8sAPI.DeleteService:output_type -> clutch.k8s.v1.DeleteServiceResponse
	26, // 61: clutch.k8s.v1.K8sAPI.UpdateStatefulSet:output_type -> clutch.k8s.v1.UpdateStatefulSetResponse
