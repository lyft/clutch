...
var file_k8s_v1_k8s_proto_rawDesc = []byte{
	...
	0x6f, 0x6e, 0x4a, 0x6f, 0x62, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x62, 0x0a,
	...
	0x6e, 0x6f, 0x74, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x32, 0x9f, 0x0d, 0x0a, 0x06, 0x4b, 0x38,
	...
	0x1c, 0x02, 0x08, 0x04, 0x12, 0x92, 0x01, 0x0a, 0x11, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x53,
	...
	0x3a, 0x01, 0x2a, 0xaa, 0xe1, 0x1c, 0x02, 0x08, 0x03, 0x12, 0x8a, 0x01, 0x0a, 0x0f, 0x44, 0x65,
...
var file_k8s_v1_k8s_proto_msgTypes = make([]protoimpl.MessageInfo, 66)
var file_k8s_v1_k8s_proto_goTypes = []interface{}{
	...
	(*NullableString)(nil),                  // 37: clutch.k8s.v1.NullableString
	(*ExpectedObjectMetaFields)(nil),        // 38: clutch.k8s.v1.ExpectedObjectMetaFields
	(*ObjectMetaFields)(nil),                // 39: clutch.k8s.v1.ObjectMetaFields
	(*RemoveObjectMetaFields)(nil),          // 40: clutch.k8s.v1.RemoveObjectMetaFields
	nil,                                     // 41: clutch.k8s.v1.DescribePodRequest.LabelsEntry
	nil,                                     // 42: clutch.k8s.v1.Pod.LabelsEntry
	nil,                                     // 43: clutch.k8s.v1.Pod.AnnotationsEntry
	nil,                                     // 44: clutch.k8s.v1.ListOptions.LabelsEntry
	(*HPA_Sizing)(nil),                      // 45: clutch.k8s.v1.HPA.Sizing
	nil,                                     // 46: clutch.k8s.v1.HPA.LabelsEntry
	nil,                                     // 47: clutch.k8s.v1.HPA.AnnotationsEntry
	(*ResizeHPARequest_Sizing)(nil),         // 48: clutch.k8s.v1.ResizeHPARequest.Sizing
	nil,                                     // 49: clutch.k8s.v1.Deployment.LabelsEntry
	nil,                                     // 50: clutch.k8s.v1.Deployment.AnnotationsEntry
	(*UpdateDeploymentRequest_Fields)(nil),  // 51: clutch.k8s.v1.UpdateDeploymentRequest.Fields
	nil,                                     // 52: clutch.k8s.v1.UpdateDeploymentRequest.Fields.LabelsEntry
	nil,                                     // 53: clutch.k8s.v1.UpdateDeploymentRequest.Fields.AnnotationsEntry
	nil,                                     // 54: clutch.k8s.v1.StatefulSet.LabelsEntry
	nil,                                     // 55: clutch.k8s.v1.StatefulSet.AnnotationsEntry
	(*UpdateStatefulSetRequest_Fields)(nil), // 56: clutch.k8s.v1.UpdateStatefulSetRequest.Fields
	nil,                                     // 57: clutch.k8s.v1.UpdateStatefulSetRequest.Fields.LabelsEntry
	nil,                                     // 58: clutch.k8s.v1.UpdateStatefulSetRequest.Fields.AnnotationsEntry
	nil,                                     // 59: clutch.k8s.v1.Service.LabelsEntry
	nil,                                     // 60: clutch.k8s.v1.Service.AnnotationsEntry
	nil,                                     // 61: clutch.k8s.v1.DescribeServiceRequest.LabelsEntry
	nil,                                     // 62: clutch.k8s.v1.CronJob.LabelsEntry
	nil,                                     // 63: clutch.k8s.v1.CronJob.AnnotationsEntry
	nil,                                     // 64: clutch.k8s.v1.DescribeCronJobRequest.LabelsEntry
	nil,                                     // 65: clutch.k8s.v1.ExpectedObjectMetaFields.LabelsEntry
	nil,                                     // 66: clutch.k8s.v1.ExpectedObjectMetaFields.AnnotationsEntry
	nil,                                     // 67: clutch.k8s.v1.ObjectMetaFields.LabelsEntry
	nil,                                     // 68: clutch.k8s.v1.ObjectMetaFields.AnnotationsEntry
	(*timestamp.Timestamp)(nil),             // 69: google.protobuf.Timestamp
	(_struct.NullValue)(0),                  // 70: google.protobuf.NullValue
}
var file_k8s_v1_k8s_proto_depIdxs = []int32{
	41, // 0: clutch.k8s.v1.DescribePodRequest.labels:type_name -> clutch.k8s.v1.DescribePodRequest.LabelsEntry
	...
	69, // 5: clutch.k8s.v1.Pod.start_time:type_name -> google.protobuf.Timestamp
	42, // 6: clutch.k8s.v1.Pod.labels:type_name -> clutch.k8s.v1.Pod.LabelsEntry
	43, // 7: clutch.k8s.v1.Pod.annotations:type_name -> clutch.k8s.v1.Pod.AnnotationsEntry
	44, // 8: clutch.k8s.v1.ListOptions.labels:type_name -> clutch.k8s.v1.ListOptions.LabelsEntry
	...
	38, // 11: clutch.k8s.v1.UpdatePodRequest.expected_object_meta_fields:type_name -> clutch.k8s.v1.ExpectedObjectMetaFields
	39, // 12: clutch.k8s.v1.UpdatePodRequest.object_meta_fields:type_name -> clutch.k8s.v1.ObjectMetaFields
	40, // 13: clutch.k8s.v1.UpdatePodRequest.remove_object_meta_fields:type_name -> clutch.k8s.v1.RemoveObjectMetaFields
	45, // 14: clutch.k8s.v1.HPA.sizing:type_name -> clutch.k8s.v1.HPA.Sizing
	46, // 15: clutch.k8s.v1.HPA.labels:type_name -> clutch.k8s.v1.HPA.LabelsEntry
	47, // 16: clutch.k8s.v1.HPA.annotations:type_name -> clutch.k8s.v1.HPA.AnnotationsEntry
	48, // 17: clutch.k8s.v1.ResizeHPARequest.sizing:type_name -> clutch.k8s.v1.ResizeHPARequest.Sizing
	49, // 18: clutch.k8s.v1.Deployment.labels:type_name -> clutch.k8s.v1.Deployment.LabelsEntry
	50, // 19: clutch.k8s.v1.Deployment.annotations:type_name -> clutch.k8s.v1.Deployment.AnnotationsEntry
	51, // 20: clutch.k8s.v1.UpdateDeploymentRequest.fields:type_name -> clutch.k8s.v1.UpdateDeploymentRequest.Fields
	54, // 21: clutch.k8s.v1.StatefulSet.labels:type_name -> clutch.k8s.v1.StatefulSet.LabelsEntry
	55, // 22: clutch.k8s.v1.StatefulSet.annotations:type_name -> clutch.k8s.v1.StatefulSet.AnnotationsEntry
	56, // 23: clutch.k8s.v1.UpdateStatefulSetRequest.fields:type_name -> clutch.k8s.v1.UpdateStatefulSetRequest.Fields
	2,  // 24: clutch.k8s.v1.Service.type:type_name -> clutch.k8s.v1.Service.Type
	59, // 25: clutch.k8s.v1.Service.labels:type_name -> clutch.k8s.v1.Service.LabelsEntry
	60, // 26: clutch.k8s.v1.Service.annotations:type_name -> clutch.k8s.v1.Service.AnnotationsEntry
	61, // 27: clutch.k8s.v1.DescribeServiceRequest.labels:type_name -> clutch.k8s.v1.DescribeServiceRequest.LabelsEntry
	27, // 28: clutch.k8s.v1.DescribeServiceResponse.service:type_name -> clutch.k8s.v1.Service
	62, // 29: clutch.k8s.v1.CronJob.labels:type_name -> clutch.k8s.v1.CronJob.LabelsEntry
	63, // 30: clutch.k8s.v1.CronJob.annotations:type_name -> clutch.k8s.v1.CronJob.AnnotationsEntry
	64, // 31: clutch.k8s.v1.DescribeCronJobRequest.labels:type_name -> clutch.k8s.v1.DescribeCronJobRequest.LabelsEntry
	32, // 32: clutch.k8s.v1.DescribeCronJobResponse.cronjob:type_name -> clutch.k8s.v1.CronJob
	70, // 33: clutch.k8s.v1.NullableString.null:type_name -> google.protobuf.NullValue
	65, // 34: clutch.k8s.v1.ExpectedObjectMetaFields.labels:type_name -> clutch.k8s.v1.ExpectedObjectMetaFields.LabelsEntry
	66, // 35: clutch.k8s.v1.ExpectedObjectMetaFields.annotations:type_name -> clutch.k8s.v1.ExpectedObjectMetaFields.AnnotationsEntry
	67, // 36: clutch.k8s.v1.ObjectMetaFields.labels:type_name -> clutch.k8s.v1.ObjectMetaFields.LabelsEntry
	68, // 37: clutch.k8s.v1.ObjectMetaFields.annotations:type_name -> clutch.k8s.v1.ObjectMetaFields.AnnotationsEntry
	52, // 38: clutch.k8s.v1.UpdateDeploymentRequest.Fields.labels:type_name -> clutch.k8s.v1.UpdateDeploymentRequest.Fields.LabelsEntry
	53, // 39: clutch.k8s.v1.UpdateDeploymentRequest.Fields.annotations:type_name -> clutch.k8s.v1.UpdateDeploymentRequest.Fields.AnnotationsEntry
	57, // 40: clutch.k8s.v1.UpdateStatefulSetRequest.Fields.labels:type_name -> clutch.k8s.v1.UpdateStatefulSetRequest.Fields.LabelsEntry
	58, // 41: clutch.k8s.v1.UpdateStatefulSetRequest.Fields.annotations:type_name -> clutch.k8s.v1.UpdateStatefulSetRequest.Fields.AnnotationsEntry
	37, // 42: clutch.k8s.v1.ExpectedObjectMetaFields.LabelsEntry.value:type_name -> clutch.k8s.v1.NullableString
	37, // 43: clutch.k8s.v1.ExpectedObjectMetaFields.AnnotationsEntry.value:type_name -> clutch.k8s.v1.NullableString
	3,  // 44: clutch.k8s.v1.K8sAPI.DescribePod:input_type -> clutch.k8s.v1.DescribePodRequest
	8,  // 45: clutch.k8s.v1.K8sAPI.ListPods:input_type -> clutch.k8s.v1.ListPodsRequest
	10, // 46: clutch.k8s.v1.K8sAPI.DeletePod:input_type -> clutch.k8s.v1.DeletePodRequest
	12, // 47: clutch.k8s.v1.K8sAPI.UpdatePod:input_type -> clutch.k8s.v1.UpdatePodRequest
	15, // 48: clutch.k8s.v1.K8sAPI.ResizeHPA:input_type -> clutch.k8s.v1.ResizeHPARequest
	17, // 49: clutch.k8s.v1.K8sAPI.DeleteHPA:input_type -> clutch.k8s.v1.DeleteHPARequest
	20, // 50: clutch.k8s.v1.K8sAPI.UpdateDeployment:input_type -> clutch.k8s.v1.UpdateDeploymentRequest
	22, // 51: clutch.k8s.v1.K8sAPI.DeleteDeployment:input_type -> clutch.k8s.v1.DeleteDeploymentRequest
	28, // 52: clutch.k8s.v1.K8sAPI.DescribeService:input_type -> clutch.k8s.v1.DescribeServiceRequest
	30, // 53: clutch.k8s.v1.K8sAPI.DeleteService:input_type -> clutch.k8s.v1.DeleteServiceRequest
	25, // 54: clutch.k8s.v1.K8sAPI.UpdateStatefulSet:input_type -> clutch.k8s.v1.UpdateStatefulSetRequest
	33, // 55: clutch.k8s.v1.K8sAPI.DescribeCronJob:input_type -> clutch.k8s.v1.DescribeCronJobRequest
	35, // 56: clutch.k8s.v1.K8sAPI.DeleteCronJob:input_type -> clutch.k8s.v1.DeleteCronJobRequest
	4,  // 57: clutch.k8s.v1.K8sAPI.DescribePod:output_type -> clutch.k8s.v1.DescribePodResponse
	9,  // 58: clutch.k8s.v1.K8sAPI.ListPods:output_type -> clutch.k8s.v1.ListPodsResponse
	11, // 59: clutch.k8s.v1.K8sAPI.DeletePod:output_type -> clutch.k8s.v1.DeletePodResponse
	13, // 60: clutch.k8s.v1.K8sAPI.UpdatePod:output_type -> clutch.k8s.v1.UpdatePodResponse
	16, // 61: clutch.k8s.v1.K8sAPI.ResizeHPA:output_type -> clutch.k8s.v1.ResizeHPAResponse
	18, // 62: clutch.k8s.v1.K8sAPI.DeleteHPA:output_type -> clutch.k8s.v1.DeleteHPAResponse
	21, // 63: clutch.k8s.v1.K8sAPI.UpdateDeployment:output_type -> clutch.k8s.v1.UpdateDeploymentResponse
	23, // 64: clutch.k8s.v1.K8sAPI.DeleteDeployment:output_type -> clutch.k8s.v1.DeleteDeploymentResponse
	29, // 65: clutch.k8s.v1.K8sAPI.DescribeService:output_type -> clutch.k8s.v1.DescribeServiceResponse
	31, // 66: clutch.k8s.v1.K8sAPI.DeleteService:output_type -> clutch.k8s.v1.DeleteServiceResponse
	26, // 67: clutch.k8s.v1.K8sAPI.UpdateStatefulSet:output_type -> clutch.k8s.v1.UpdateStatefulSetResponse
	34, // 68: clutch.k8s.v1.K8sAPI.DescribeCronJob:output_type -> clutch.k8s.v1.DescribeCronJobResponse
	36, // 69: clutch.k8s.v1.K8sAPI.DeleteCronJob:output_type -> clutch.k8s.v1.DeleteCronJobResponse
...
func file_k8s_v1_k8s_proto_init() {
	...
	file_k8s_v1_k8s_proto_msgTypes[34].OneofWrappers = []interface{}{
