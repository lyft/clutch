...
var file_k8s_v1_k8s_proto_rawDesc = []byte{
	...
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x62, 0x0a, 0x0e, 0x4e, 0x75, 0x6c, 0x6c, 0x61, 0x62, 0x6c,
	...
	0x73, 0x32, 0x97, 0x19, 0x0a, 0x06, 0x4b, 0x38, 0x73, 0x41, 0x50, 0x49, 0x12, 0x7a, 0x0a, 0x0b,
	...
	0x6f, 0x62, 0x3a, 0x01, 0x2a, 0xaa, 0xe1, 0x1c, 0x02, 0x08, 0x04, 0x42, 0x31, 0x5a, 0x2f, 0x67,
...
var file_k8s_v1_k8s_proto_goTypes = []interface{}{
	...
	(*NullableString)(nil),                  // 61: clutch.k8s.v1.NullableString
	(*ExpectedObjectMetaFields)(nil),        // 62: clutch.k8s.v1.ExpectedObjectMetaFields
	(*ObjectMetaFields)(nil),                // 63: clutch.k8s.v1.ObjectMetaFields
	(*RemoveObjectMetaFields)(nil),          // 64: clutch.k8s.v1.RemoveObjectMetaFields
	nil,                                     // 65: clutch.k8s.v1.DescribePodRequest.LabelsEntry
	nil,                                     // 66: clutch.k8s.v1.Pod.LabelsEntry
	nil,                                     // 67: clutch.k8s.v1.Pod.AnnotationsEntry
	nil,                                     // 68: clutch.k8s.v1.ListOptions.LabelsEntry
	(*HPA_Sizing)(nil),                      // 69: clutch.k8s.v1.HPA.Sizing
	nil,                                     // 70: clutch.k8s.v1.HPA.LabelsEntry
	nil,                                     // 71: clutch.k8s.v1.HPA.AnnotationsEntry
	(*ResizeHPARequest_Sizing)(nil),         // 72: clutch.k8s.v1.ResizeHPARequest.Sizing
	nil,                                     // 73: clutch.k8s.v1.Deployment.LabelsEntry
	nil,                                     // 74: clutch.k8s.v1.Deployment.AnnotationsEntry
	nil,                                     // 75: clutch.k8s.v1.DescribeDeploymentRequest.LabelsEntry
	(*UpdateDeploymentRequest_Fields)(nil),  // 76: clutch.k8s.v1.UpdateDeploymentRequest.Fields
	nil,                                     // 77: clutch.k8s.v1.UpdateDeploymentRequest.Fields.LabelsEntry
	nil,                                     // 78: clutch.k8s.v1.UpdateDeploymentRequest.Fields.AnnotationsEntry
	nil,                                     // 79: clutch.k8s.v1.StatefulSet.LabelsEntry
	nil,                                     // 80: clutch.k8s.v1.StatefulSet.AnnotationsEntry
	nil,                                     // 81: clutch.k8s.v1.DescribeStatefulSetRequest.LabelsEntry
	(*UpdateStatefulSetRequest_Fields)(nil), // 82: clutch.k8s.v1.UpdateStatefulSetRequest.Fields
	nil,                                     // 83: clutch.k8s.v1.UpdateStatefulSetRequest.Fields.LabelsEntry
	nil,                                     // 84: clutch.k8s.v1.UpdateStatefulSetRequest.Fields.AnnotationsEntry
	nil,                                     // 85: clutch.k8s.v1.Service.LabelsEntry
	nil,                                     // 86: clutch.k8s.v1.Service.AnnotationsEntry
	nil,                                     // 87: clutch.k8s.v1.DescribeServiceRequest.LabelsEntry
	nil,                                     // 88: clutch.k8s.v1.CronJob.LabelsEntry
	nil,                                     // 89: clutch.k8s.v1.CronJob.AnnotationsEntry
	nil,                                     // 90: clutch.k8s.v1.DescribeCronJobRequest.LabelsEntry
	nil,                                     // 91: clutch.k8s.v1.ConfigMap.AnnotationsEntry
	nil,                                     // 92: clutch.k8s.v1.ConfigMap.LabelsEntry
	nil,                                     // 93: clutch.k8s.v1.DescribeConfigMapRequest.LabelsEntry
	nil,                                     // 94: clutch.k8s.v1.DescribeConfigMapRequest.AnnotationsEntry
	nil,                                     // 95: clutch.k8s.v1.Job.AnnotationsEntry
	nil,                                     // 96: clutch.k8s.v1.Job.LabelsEntry
	nil,                                     // 97: clutch.k8s.v1.ExpectedObjectMetaFields.LabelsEntry
	nil,                                     // 98: clutch.k8s.v1.ExpectedObjectMetaFields.AnnotationsEntry
	nil,                                     // 99: clutch.k8s.v1.ObjectMetaFields.LabelsEntry
	nil,                                     // 100: clutch.k8s.v1.ObjectMetaFields.AnnotationsEntry
	(*timestamppb.Timestamp)(nil),           // 101: google.protobuf.Timestamp
	(structpb.NullValue)(0),                 // 102: google.protobuf.NullValue
}
var file_k8s_v1_k8s_proto_depIdxs = []int32{
	65,  // 0: clutch.k8s.v1.DescribePodRequest.labels:type_name -> clutch.k8s.v1.DescribePodRequest.LabelsEntry
	...
	101, // 5: clutch.k8s.v1.Pod.start_time:type_name -> google.protobuf.Timestamp
	66,  // 6: clutch.k8s.v1.Pod.labels:type_name -> clutch.k8s.v1.Pod.LabelsEntry
	67,  // 7: clutch.k8s.v1.Pod.annotations:type_name -> clutch.k8s.v1.Pod.AnnotationsEntry
	68,  // 8: clutch.k8s.v1.ListOptions.labels:type_name -> clutch.k8s.v1.ListOptions.LabelsEntry
	...
	62,  // 11: clutch.k8s.v1.UpdatePodRequest.expected_object_meta_fields:type_name -> clutch.k8s.v1.ExpectedObjectMetaFields
	63,  // 12: clutch.k8s.v1.UpdatePodRequest.object_meta_fields:type_name -> clutch.k8s.v1.ObjectMetaFields
	64,  // 13: clutch.k8s.v1.UpdatePodRequest.remove_object_meta_fields:type_name -> clutch.k8s.v1.RemoveObjectMetaFields
	69,  // 14: clutch.k8s.v1.HPA.sizing:type_name -> clutch.k8s.v1.HPA.Sizing
	70,  // 15: clutch.k8s.v1.HPA.labels:type_name -> clutch.k8s.v1.HPA.LabelsEntry
	71,  // 16: clutch.k8s.v1.HPA.annotations:type_name -> clutch.k8s.v1.HPA.AnnotationsEntry
	72,  // 17: clutch.k8s.v1.ResizeHPARequest.sizing:type_name -> clutch.k8s.v1.ResizeHPARequest.Sizing
	73,  // 18: clutch.k8s.v1.Deployment.labels:type_name -> clutch.k8s.v1.Deployment.LabelsEntry
	74,  // 19: clutch.k8s.v1.Deployment.annotations:type_name -> clutch.k8s.v1.Deployment.AnnotationsEntry
	75,  // 20: clutch.k8s.v1.DescribeDeploymentRequest.labels:type_name -> clutch.k8s.v1.DescribeDeploymentRequest.LabelsEntry
	...
	76,  // 24: clutch.k8s.v1.UpdateDeploymentRequest.fields:type_name -> clutch.k8s.v1.UpdateDeploymentRequest.Fields
	79,  // 25: clutch.k8s.v1.StatefulSet.labels:type_name -> clutch.k8s.v1.StatefulSet.LabelsEntry
	80,  // 26: clutch.k8s.v1.StatefulSet.annotations:type_name -> clutch.k8s.v1.StatefulSet.AnnotationsEntry
	81,  // 27: clutch.k8s.v1.DescribeStatefulSetRequest.labels:type_name -> clutch.k8s.v1.DescribeStatefulSetRequest.LabelsEntry
	...
	82,  // 31: clutch.k8s.v1.UpdateStatefulSetRequest.fields:type_name -> clutch.k8s.v1.UpdateStatefulSetRequest.Fields
	2,   // 32: clutch.k8s.v1.Service.type:type_name -> clutch.k8s.v1.Service.Type
	85,  // 33: clutch.k8s.v1.Service.labels:type_name -> clutch.k8s.v1.Service.LabelsEntry
	86,  // 34: clutch.k8s.v1.Service.annotations:type_name -> clutch.k8s.v1.Service.AnnotationsEntry
	87,  // 35: clutch.k8s.v1.DescribeServiceRequest.labels:type_name -> clutch.k8s.v1.DescribeServiceRequest.LabelsEntry
	37,  // 36: clutch.k8s.v1.DescribeServiceResponse.service:type_name -> clutch.k8s.v1.Service
	88,  // 37: clutch.k8s.v1.CronJob.labels:type_name -> clutch.k8s.v1.CronJob.LabelsEntry
	89,  // 38: clutch.k8s.v1.CronJob.annotations:type_name -> clutch.k8s.v1.CronJob.AnnotationsEntry
	90,  // 39: clutch.k8s.v1.DescribeCronJobRequest.labels:type_name -> clutch.k8s.v1.DescribeCronJobRequest.LabelsEntry
	...
	91,  // 43: clutch.k8s.v1.ConfigMap.annotations:type_name -> clutch.k8s.v1.ConfigMap.AnnotationsEntry
	92,  // 44: clutch.k8s.v1.ConfigMap.labels:type_name -> clutch.k8s.v1.ConfigMap.LabelsEntry
	...
	93,  // 47: clutch.k8s.v1.DescribeConfigMapRequest.labels:type_name -> clutch.k8s.v1.DescribeConfigMapRequest.LabelsEntry
	94,  // 48: clutch.k8s.v1.DescribeConfigMapRequest.annotations:type_name -> clutch.k8s.v1.DescribeConfigMapRequest.AnnotationsEntry
	49,  // 49: clutch.k8s.v1.DescribeConfigMapResponse.config_map:type_name -> clutch.k8s.v1.ConfigMap
	95,  // 50: clutch.k8s.v1.Job.annotations:type_name -> clutch.k8s.v1.Job.AnnotationsEntry
	96,  // 51: clutch.k8s.v1.Job.labels:type_name -> clutch.k8s.v1.Job.LabelsEntry
	...
	102, // 54: clutch.k8s.v1.NullableString.null:type_name -> google.protobuf.NullValue
	97,  // 55: clutch.k8s.v1.ExpectedObjectMetaFields.labels:type_name -> clutch.k8s.v1.ExpectedObjectMetaFields.LabelsEntry
	98,  // 56: clutch.k8s.v1.ExpectedObjectMetaFields.annotations:type_name -> clutch.k8s.v1.ExpectedObjectMetaFields.AnnotationsEntry
	99,  // 57: clutch.k8s.v1.ObjectMetaFields.labels:type_name -> clutch.k8s.v1.ObjectMetaFields.LabelsEntry
	100, // 58: clutch.k8s.v1.ObjectMetaFields.annotations:type_name -> clutch.k8s.v1.ObjectMetaFields.AnnotationsEntry
	77,  // 59: clutch.k8s.v1.UpdateDeploymentRequest.Fields.labels:type_name -> clutch.k8s.v1.UpdateDeploymentRequest.Fields.LabelsEntry
	78,  // 60: clutch.k8s.v1.UpdateDeploymentRequest.Fields.annotations:type_name -> clutch.k8s.v1.UpdateDeploymentRequest.Fields.AnnotationsEntry
	83,  // 61: clutch.k8s.v1.UpdateStatefulSetRequest.Fields.labels:type_name -> clutch.k8s.v1.UpdateStatefulSetRequest.Fields.LabelsEntry
	84,  // 62: clutch.k8s.v1.UpdateStatefulSetRequest.Fields.annotations:type_name -> clutch.k8s.v1.UpdateStatefulSetRequest.Fields.AnnotationsEntry
	61,  // 63: clutch.k8s.v1.ExpectedObjectMetaFields.LabelsEntry.value:type_name -> clutch.k8s.v1.NullableString
	61,  // 64: clutch.k8s.v1.ExpectedObjectMetaFields.AnnotationsEntry.value:type_name -> clutch.k8s.v1.NullableString
	3,   // 65: clutch.k8s.v1.K8sAPI.DescribePod:input_type -> clutch.k8s.v1.DescribePodRequest
	8,   // 66: clutch.k8s.v1.K8sAPI.ListPods:input_type -> clutch.k8s.v1.ListPodsRequest
	10,  // 67: clutch.k8s.v1.K8sAPI.DeletePod:input_type -> clutch.k8s.v1.DeletePodRequest
	12,  // 68: clutch.k8s.v1.K8sAPI.UpdatePod:input_type -> clutch.k8s.v1.UpdatePodRequest
	15,  // 69: clutch.k8s.v1.K8sAPI.ResizeHPA:input_type -> clutch.k8s.v1.ResizeHPARequest
	17,  // 70: clutch.k8s.v1.K8sAPI.DeleteHPA:input_type -> clutch.k8s.v1.DeleteHPARequest
	20,  // 71: clutch.k8s.v1.K8sAPI.DescribeDeployment:input_type -> clutch.k8s.v1.DescribeDeploymentRequest
	22,  // 72: clutch.k8s.v1.K8sAPI.ListDeployments:input_type -> clutch.k8s.v1.ListDeploymentsRequest
	24,  // 73: clutch.k8s.v1.K8sAPI.UpdateDeployment:input_type -> clutch.k8s.v1.UpdateDeploymentRequest
	26,  // 74: clutch.k8s.v1.K8sAPI.DeleteDeployment:input_type -> clutch.k8s.v1.DeleteDeploymentRequest
	38,  // 75: clutch.k8s.v1.K8sAPI.DescribeService:input_type -> clutch.k8s.v1.DescribeServiceRequest
	40,  // 76: clutch.k8s.v1.K8sAPI.DeleteService:input_type -> clutch.k8s.v1.DeleteServiceRequest
	29,  // 77: clutch.k8s.v1.K8sAPI.DescribeStatefulSet:input_type -> clutch.k8s.v1.DescribeStatefulSetRequest
	31,  // 78: clutch.k8s.v1.K8sAPI.ListStatefulSets:input_type -> clutch.k8s.v1.ListStatefulSetsRequest
	35,  // 79: clutch.k8s.v1.K8sAPI.UpdateStatefulSet:input_type -> clutch.k8s.v1.UpdateStatefulSetRequest
	33,  // 80: clutch.k8s.v1.K8sAPI.DeleteStatefulSet:input_type -> clutch.k8s.v1.DeleteStatefulSetRequest
	43,  // 81: clutch.k8s.v1.K8sAPI.DescribeCronJob:input_type -> clutch.k8s.v1.DescribeCronJobRequest
	45,  // 82: clutch.k8s.v1.K8sAPI.ListCronJobs:input_type -> clutch.k8s.v1.ListCronJobsRequest
	47,  // 83: clutch.k8s.v1.K8sAPI.DeleteCronJob:input_type -> clutch.k8s.v1.DeleteCronJobRequest
	50,  // 84: clutch.k8s.v1.K8sAPI.ListConfigMaps:input_type -> clutch.k8s.v1.ListConfigMapsRequest
	52,  // 85: clutch.k8s.v1.K8sAPI.DescribeConfigMap:input_type -> clutch.k8s.v1.DescribeConfigMapRequest
	54,  // 86: clutch.k8s.v1.K8sAPI.DeleteConfigMap:input_type -> clutch.k8s.v1.DeleteConfigMapRequest
	57,  // 87: clutch.k8s.v1.K8sAPI.ListJobs:input_type -> clutch.k8s.v1.ListJobsRequest
	59,  // 88: clutch.k8s.v1.K8sAPI.DeleteJob:input_type -> clutch.k8s.v1.DeleteJobRequest
	4,   // 89: clutch.k8s.v1.K8sAPI.DescribePod:output_type -> clutch.k8s.v1.DescribePodResponse
	9,   // 90: clutch.k8s.v1.K8sAPI.ListPods:output_type -> clutch.k8s.v1.ListPodsResponse
	11,  // 91: clutch.k8s.v1.K8sAPI.DeletePod:output_type -> clutch.k8s.v1.DeletePodResponse
	13,  // 92: clutch.k8s.v1.K8sAPI.UpdatePod:output_type -> clutch.k8s.v1.UpdatePodResponse
	16,  // 93: clutch.k8s.v1.K8sAPI.ResizeHPA:output_type -> clutch.k8s.v1.ResizeHPAResponse
	18,  // 94: clutch.k8s.v1.K8sAPI.DeleteHPA:output_type -> clutch.k8s.v1.DeleteHPAResponse
	21,  // 95: clutch.k8s.v1.K8sAPI.DescribeDeployment:output_type -> clutch.k8s.v1.DescribeDeploymentResponse
	23,  // 96: clutch.k8s.v1.K8sAPI.ListDeployments:output_type -> clutch.k8s.v1.ListDeploymentsResponse
	25,  // 97: clutch.k8s.v1.K8sAPI.UpdateDeployment:output_type -> clutch.k8s.v1.UpdateDeploymentResponse
	27,  // 98: clutch.k8s.v1.K8sAPI.DeleteDeployment:output_type -> clutch.k8s.v1.DeleteDeploymentResponse
	39,  // 99: clutch.k8s.v1.K8sAPI.DescribeService:output_type -> clutch.k8s.v1.DescribeServiceResponse
	41,  // 100: clutch.k8s.v1.K8sAPI.DeleteService:output_type -> clutch.k8s.v1.DeleteServiceResponse
	30,  // 101: clutch.k8s.v1.K8sAPI.DescribeStatefulSet:output_type -> clutch.k8s.v1.DescribeStatefulSetResponse
	32,  // 102: clutch.k8s.v1.K8sAPI.ListStatefulSets:output_type -> clutch.k8s.v1.ListStatefulSetsResponse
	36,  // 103: clutch.k8s.v1.K8sAPI.UpdateStatefulSet:output_type -> clutch.k8s.v1.UpdateStatefulSetResponse
	34,  // 104: clutch.k8s.v1.K8sAPI.DeleteStatefulSet:output_type -> clutch.k8s.v1.DeleteStatefulSetResponse
	44,  // 105: clutch.k8s.v1.K8sAPI.DescribeCronJob:output_type -> clutch.k8s.v1.DescribeCronJobResponse
	46,  // 106: clutch.k8s.v1.K8sAPI.ListCronJobs:output_type -> clutch.k8s.v1.ListCronJobsResponse
	48,  // 107: clutch.k8s.v1.K8sAPI.DeleteCronJob:output_type -> clutch.k8s.v1.DeleteCronJobResponse
	51,  // 108: clutch.k8s.v1.K8sAPI.ListConfigMaps:output_type -> clutch.k8s.v1.ListConfigMapsResponse
	53,  // 109: clutch.k8s.v1.K8sAPI.DescribeConfigMap:output_type -> clutch.k8s.v1.DescribeConfigMapResponse
	55,  // 110: clutch.k8s.v1.K8sAPI.DeleteConfigMap:output_type -> clutch.k8s.v1.DeleteConfigMapResponse
	58,  // 111: clutch.k8s.v1.K8sAPI.ListJobs:output_type -> clutch.k8s.v1.ListJobsResponse
	60,  // 112: clutch.k8s.v1.K8sAPI.DeleteJob:output_type -> clutch.k8s.v1.DeleteJobResponse
