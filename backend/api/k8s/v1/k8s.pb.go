...
var file_k8s_v1_k8s_proto_rawDesc = []byte{
	...
	0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0xa8, 0x03, 0x0a, 0x07, 0x53, 0x65,
	...
	0x65, 0x79, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x6b, 0x65, 0x79, 0x12, 0x14, 0x0a,
	0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x76, 0x61,
	0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x3a, 0x3b, 0xb2, 0xe1, 0x1c, 0x37, 0x0a, 0x35, 0x0a,
	...
	0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x62, 0x0a, 0x0e, 0x4e, 0x75, 0x6c, 0x6c, 0x61,
	...
	0x6f, 0x6e, 0x73, 0x32, 0xf8, 0x09, 0x0a, 0x06, 0x4b, 0x38, 0x73, 0x41, 0x50, 0x49, 0x12, 0x7a,
	...
	0x41, 0x3a, 0x01, 0x2a, 0xaa, 0xe1, 0x1c, 0x02, 0x08, 0x04, 0x12, 0x8e, 0x01, 0x0a, 0x10, 0x55,
	...
	0x72, 0x76, 0x69, 0x63, 0x65, 0x3a, 0x01, 0x2a, 0xaa, 0xe1, 0x1c, 0x02, 0x08, 0x04, 0x42, 0x31,
...
var file_k8s_v1_k8s_proto_goTypes = []interface{}{
	...
	(*DeleteHPARequest)(nil),               // 16: clutch.k8s.v1.DeleteHPARequest
	(*DeleteHPAResponse)(nil),              // 17: clutch.k8s.v1.DeleteHPAResponse
	(*Deployment)(nil),                     // 18: clutch.k8s.v1.Deployment
	(*UpdateDeploymentRequest)(nil),        // 19: clutch.k8s.v1.UpdateDeploymentRequest
	(*UpdateDeploymentResponse)(nil),       // 20: clutch.k8s.v1.UpdateDeploymentResponse
	(*DeleteDeploymentRequest)(nil),        // 21: clutch.k8s.v1.DeleteDeploymentRequest
	(*DeleteDeploymentResponse)(nil),       // 22: clutch.k8s.v1.DeleteDeploymentResponse
	(*Service)(nil),                        // 23: clutch.k8s.v1.Service
	(*DescribeServiceRequest)(nil),         // 24: clutch.k8s.v1.DescribeServiceRequest
	(*DescribeServiceResponse)(nil),        // 25: clutch.k8s.v1.DescribeServiceResponse
	(*DeleteServiceRequest)(nil),           // 26: clutch.k8s.v1.DeleteServiceRequest
	(*DeleteServiceResponse)(nil),          // 27: clutch.k8s.v1.DeleteServiceResponse
	(*NullableString)(nil),                 // 28: clutch.k8s.v1.NullableString
	(*ExpectedObjectMetaFields)(nil),       // 29: clutch.k8s.v1.ExpectedObjectMetaFields
	(*ObjectMetaFields)(nil),               // 30: clutch.k8s.v1.ObjectMetaFields
	(*RemoveObjectMetaFields)(nil),         // 31: clutch.k8s.v1.RemoveObjectMetaFields
	nil,                                    // 32: clutch.k8s.v1.DescribePodRequest.LabelsEntry
	nil,                                    // 33: clutch.k8s.v1.Pod.LabelsEntry
	nil,                                    // 34: clutch.k8s.v1.Pod.AnnotationsEntry
	nil,                                    // 35: clutch.k8s.v1.ListOptions.LabelsEntry
	(*HPA_Sizing)(nil),                     // 36: clutch.k8s.v1.HPA.Sizing
	nil,                                    // 37: clutch.k8s.v1.HPA.LabelsEntry
	nil,                                    // 38: clutch.k8s.v1.HPA.AnnotationsEntry
	(*ResizeHPARequest_Sizing)(nil),        // 39: clutch.k8s.v1.ResizeHPARequest.Sizing
	nil,                                    // 40: clutch.k8s.v1.Deployment.LabelsEntry
	nil,                                    // 41: clutch.k8s.v1.Deployment.AnnotationsEntry
	(*UpdateDeploymentRequest_Fields)(nil), // 42: clutch.k8s.v1.UpdateDeploymentRequest.Fields
	nil,                                    // 43: clutch.k8s.v1.UpdateDeploymentRequest.Fields.LabelsEntry
	nil,                                    // 44: clutch.k8s.v1.UpdateDeploymentRequest.Fields.AnnotationsEntry
	nil,                                    // 45: clutch.k8s.v1.Service.LabelsEntry
	nil,                                    // 46: clutch.k8s.v1.Service.AnnotationsEntry
	nil,                                    // 47: clutch.k8s.v1.DescribeServiceRequest.LabelsEntry
	nil,                                    // 48: clutch.k8s.v1.ExpectedObjectMetaFields.LabelsEntry
	nil,                                    // 49: clutch.k8s.v1.ExpectedObjectMetaFields.AnnotationsEntry
	nil,                                    // 50: clutch.k8s.v1.ObjectMetaFields.LabelsEntry
	nil,                                    // 51: clutch.k8s.v1.ObjectMetaFields.AnnotationsEntry
	(*timestamp.Timestamp)(nil),            // 52: google.protobuf.Timestamp
	(_struct.NullValue)(0),                 // 53: google.protobuf.NullValue
}
var file_k8s_v1_k8s_proto_depIdxs = []int32{
	32, // 0: clutch.k8s.v1.DescribePodRequest.labels:type_name -> clutch.k8s.v1.DescribePodRequest.LabelsEntry
	...
	52, // 5: clutch.k8s.v1.Pod.start_time:type_name -> google.protobuf.Timestamp
	33, // 6: clutch.k8s.v1.Pod.labels:type_name -> clutch.k8s.v1.Pod.LabelsEntry
	34, // 7: clutch.k8s.v1.Pod.annotations:type_name -> clutch.k8s.v1.Pod.AnnotationsEntry
	35, // 8: clutch.k8s.v1.ListOptions.labels:type_name -> clutch.k8s.v1.ListOptions.LabelsEntry
	...
	29, // 11: clutch.k8s.v1.UpdatePodRequest.expected_object_meta_fields:type_name -> clutch.k8s.v1.ExpectedObjectMetaFields
	30, // 12: clutch.k8s.v1.UpdatePodRequest.object_meta_fields:type_name -> clutch.k8s.v1.ObjectMetaFields
	31, // 13: clutch.k8s.v1.UpdatePodRequest.remove_object_meta_fields:type_name -> clutch.k8s.v1.RemoveObjectMetaFields
	36, // 14: clutch.k8s.v1.HPA.sizing:type_name -> clutch.k8s.v1.HPA.Sizing
	37, // 15: clutch.k8s.v1.HPA.labels:type_name -> clutch.k8s.v1.HPA.LabelsEntry
	38, // 16: clutch.k8s.v1.HPA.annotations:type_name -> clutch.k8s.v1.HPA.AnnotationsEntry
	39, // 17: clutch.k8s.v1.ResizeHPARequest.sizing:type_name -> clutch.k8s.v1.ResizeHPARequest.Sizing
	40, // 18: clutch.k8s.v1.Deployment.labels:type_name -> clutch.k8s.v1.Deployment.LabelsEntry
	41, // 19: clutch.k8s.v1.Deployment.annotations:type_name -> clutch.k8s.v1.Deployment.AnnotationsEntry
	42, // 20: clutch.k8s.v1.UpdateDeploymentRequest.fields:type_name -> clutch.k8s.v1.UpdateDeploymentRequest.Fields
	45, // 21: clutch.k8s.v1.Service.labels:type_name -> clutch.k8s.v1.Service.LabelsEntry
	46, // 22: clutch.k8s.v1.Service.annotations:type_name -> clutch.k8s.v1.Service.AnnotationsEntry
	47, // 23: clutch.k8s.v1.DescribeServiceRequest.labels:type_name -> clutch.k8s.v1.DescribeServiceRequest.LabelsEntry
	23, // 24: clutch.k8s.v1.DescribeServiceResponse.service:type_name -> clutch.k8s.v1.Service
	53, // 25: clutch.k8s.v1.NullableString.null:type_name -> google.protobuf.NullValue
	48, // 26: clutch.k8s.v1.ExpectedObjectMetaFields.labels:type_name -> clutch.k8s.v1.ExpectedObjectMetaFields.LabelsEntry
	49, // 27: clutch.k8s.v1.ExpectedObjectMetaFields.annotations:type_name -> clutch.k8s.v1.ExpectedObjectMetaFields.AnnotationsEntry
	50, // 28: clutch.k8s.v1.ObjectMetaFields.labels:type_name -> clutch.k8s.v1.ObjectMetaFields.LabelsEntry
	51, // 29: clutch.k8s.v1.ObjectMetaFields.annotations:type_name -> clutch.k8s.v1.ObjectMetaFields.AnnotationsEntry
	43, // 30: clutch.k8s.v1.UpdateDeploymentRequest.Fields.labels:type_name -> clutch.k8s.v1.UpdateDeploymentRequest.Fields.LabelsEntry
	44, // 31: clutch.k8s.v1.UpdateDeploymentRequest.Fields.annotations:type_name -> clutch.k8s.v1.UpdateDeploymentRequest.Fields.AnnotationsEntry
	28, // 32: clutch.k8s.v1.ExpectedObjectMetaFields.LabelsEntry.value:type_name -> clutch.k8s.v1.NullableString
	28, // 33: clutch.k8s.v1.ExpectedObjectMetaFields.AnnotationsEntry.value:type_name -> clutch.k8s.v1.NullableString
	2,  // 34: clutch.k8s.v1.K8sAPI.DescribePod:input_type -> clutch.k8s.v1.DescribePodRequest
	7,  // 35: clutch.k8s.v1.K8sAPI.ListPods:input_type -> clutch.k8s.v1.ListPodsRequest
	9,  // 36: clutch.k8s.v1.K8sAPI.DeletePod:input_type -> clutch.k8s.v1.DeletePodRequest
	11, // 37: clutch.k8s.v1.K8sAPI.UpdatePod:input_type -> clutch.k8s.v1.UpdatePodRequest
	14, // 38: clutch.k8s.v1.K8sAPI.ResizeHPA:input_type -> clutch.k8s.v1.ResizeHPARequest
	16, // 39: clutch.k8s.v1.K8sAPI.DeleteHPA:input_type -> clutch.k8s.v1.DeleteHPARequest
	19, // 40: clutch.k8s.v1.K8sAPI.UpdateDeployment:input_type -> clutch.k8s.v1.UpdateDeploymentRequest
	21, // 41: clutch.k8s.v1.K8sAPI.DeleteDeployment:input_type -> clutch.k8s.v1.DeleteDeploymentRequest
	24, // 42: clutch.k8s.v1.K8sAPI.DescribeService:input_type -> clutch.k8s.v1.DescribeServiceRequest
	26, // 43: clutch.k8s.v1.K8sAPI.DeleteService:input_type -> clutch.k8s.v1.DeleteServiceRequest
	3,  // 44: clutch.k8s.v1.K8sAPI.DescribePod:output_type -> clutch.k8s.v1.DescribePodResponse
	8,  // 45: clutch.k8s.v1.K8sAPI.ListPods:output_type -> clutch.k8s.v1.ListPodsResponse
	10, // 46: clutch.k8s.v1.K8sAPI.DeletePod:output_type -> clutch.k8s.v1.DeletePodResponse
	12, // 47: clutch.k8s.v1.K8sAPI.UpdatePod:output_type -> clutch.k8s.v1.UpdatePodResponse
	15, // 48: clutch.k8s.v1.K8sAPI.ResizeHPA:output_type -> clutch.k8s.v1.ResizeHPAResponse
	17, // 49: clutch.k8s.v1.K8sAPI.DeleteHPA:output_type -> clutch.k8s.v1.DeleteHPAResponse
	20, // 50: clutch.k8s.v1.K8sAPI.UpdateDeployment:output_type -> clutch.k8s.v1.UpdateDeploymentResponse
	22, // 51: clutch.k8s.v1.K8sAPI.DeleteDeployment:output_type -> clutch.k8s.v1.DeleteDeploymentResponse
	25, // 52: clutch.k8s.v1.K8sAPI.DescribeService:output_type -> clutch.k8s.v1.DescribeServiceResponse
	27, // 53: clutch.k8s.v1.K8sAPI.DeleteService:output_type -> clutch.k8s.v1.DeleteServiceResponse
