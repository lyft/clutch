...
type GetProjectsRequest struct {
	...
	// If this is set to true, the api will include all project dependencies for the requested projects.
	// https://github.com/lyft/clutch/blob/2304adf0e0189734d8a36803964214ee3bc73fbc/api/core/project/v1/project.proto#L19
	IncludeDependencies bool `protobuf:"varint,3,opt,name=include_dependencies,json=includeDependencies,proto3" json:"include_dependencies,omitempty"`
}
...
func (x *GetProjectsRequest) GetIncludeDependencies() bool {
	if x != nil {
...
var file_project_v1_project_proto_rawDesc = []byte{
	...
	0x75, 0x73, 0x65, 0x72, 0x73, 0x12, 0x31, 0x0a, 0x14, 0x69, 0x6e, 0x63, 0x6c, 0x75, 0x64, 0x65,
