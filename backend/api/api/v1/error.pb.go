...
type ErrorMetadata struct {
	...
	Metadata map[string]*_struct.Value `protobuf:"bytes,1,rep,name=metadata,proto3" json:"metadata,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
...
func (x *ErrorMetadata) GetMetadata() map[string]*_struct.Value {
	if x != nil {
		return x.Metadata
	}
	return nil
