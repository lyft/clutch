...
func RegisterSlackBotAPIHandlerServer(ctx context.Context, mux *runtime.ServeMux, server SlackBotAPIServer) error {
	...
	mux.Handle("POST", pattern_SlackBotAPI_Event_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		ctx, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/clutch.bot.slackbot.v1.SlackBotAPI/Event", runtime.WithHTTPPathPattern("/v1/bot/slackbot/event"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_SlackBotAPI_Event_0(ctx, inboundMarshaler, server, req, pathParams)
...
func RegisterSlackBotAPIHandlerClient(ctx context.Context, mux *runtime.ServeMux, client SlackBotAPIClient) error {
	...
	mux.Handle("POST", pattern_SlackBotAPI_Event_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		var err error
		ctx, err = runtime.AnnotateContext(ctx, mux, req, "/clutch.bot.slackbot.v1.SlackBotAPI/Event", runtime.WithHTTPPathPattern("/v1/bot/slackbot/event"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_SlackBotAPI_Event_0(ctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
