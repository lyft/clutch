...
var (
	pattern_EC2API_GetInstance_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"v1", "aws", "ec2", "getInstance"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_EC2API_TerminateInstance_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"v1", "aws", "ec2", "terminateInstance"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_EC2API_ResizeAutoscalingGroup_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"v1", "aws", "ec2", "resizeAutoscalingGroup"}, "", runtime.AssumeColonVerbOpt(true)))
)
