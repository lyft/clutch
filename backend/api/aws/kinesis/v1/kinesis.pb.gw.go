...
func RegisterKinesisAPIHandlerServer(ctx context.Context, mux *runtime.ServeMux, server KinesisAPIServer) error {
	...
	mux.Handle("POST", pattern_KinesisAPI_GetStream_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := local_request_KinesisAPI_GetStream_0(rctx, inboundMarshaler, server, req, pathParams)
	...
	mux.Handle("POST", pattern_KinesisAPI_UpdateShardCount_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := local_request_KinesisAPI_UpdateShardCount_0(rctx, inboundMarshaler, server, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
...
func RegisterKinesisAPIHandlerClient(ctx context.Context, mux *runtime.ServeMux, client KinesisAPIClient) error {
	...
	mux.Handle("POST", pattern_KinesisAPI_GetStream_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_KinesisAPI_GetStream_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
	...
	mux.Handle("POST", pattern_KinesisAPI_UpdateShardCount_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_KinesisAPI_UpdateShardCount_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
...
var (
	pattern_KinesisAPI_GetStream_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"v1", "aws", "kinesis", "getStream"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_KinesisAPI_UpdateShardCount_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"v1", "aws", "kinesis", "updateShardCount"}, "", runtime.AssumeColonVerbOpt(true)))
)
