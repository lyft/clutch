...
var (
	pattern_TopologyAPI_GetTopology_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"v1", "topology", "getTopology"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_TopologyAPI_SearchTopology_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"v1", "topology", "search"}, "", runtime.AssumeColonVerbOpt(true)))
)
