...
// This is also a place where we can add other dependency types such as datastores.
type ProjectDependencies struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// Projects that are Upstreams and Downstreams of this project, the values are other Project.Name's.
	Upstreams   []string `protobuf:"bytes,1,rep,name=upstreams,proto3" json:"upstreams,omitempty"`
	Downstreams []string `protobuf:"bytes,2,rep,name=downstreams,proto3" json:"downstreams,omitempty"`
}
...
func (x *ProjectDependencies) GetUpstreams() []string {
	if x != nil {
		return x.Upstreams
	}
	return nil
...
func (x *ProjectDependencies) GetDownstreams() []string {
	if x != nil {
...
var file_core_project_v1_project_proto_rawDesc = []byte{
	...
	0x22, 0x55, 0x0a, 0x13, 0x50, 0x72, 0x6f, 0x6a, 0x65, 0x63, 0x74, 0x44, 0x65, 0x70, 0x65, 0x6e,
	0x64, 0x65, 0x6e, 0x63, 0x69, 0x65, 0x73, 0x12, 0x1c, 0x0a, 0x09, 0x75, 0x70, 0x73, 0x74, 0x72,
	0x65, 0x61, 0x6d, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x09, 0x52, 0x09, 0x75, 0x70, 0x73, 0x74,
	0x72, 0x65, 0x61, 0x6d, 0x73, 0x12, 0x20, 0x0a, 0x0b, 0x64, 0x6f, 0x77, 0x6e, 0x73, 0x74, 0x72,
	0x65, 0x61, 0x6d, 0x73, 0x18, 0x02, 0x20, 0x03, 0x28, 0x09, 0x52, 0x0b, 0x64, 0x6f, 0x77, 0x6e,
	0x73, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x73, 0x42, 0x3e, 0x5a, 0x3c, 0x67, 0x69, 0x74, 0x68, 0x75,
...
var file_core_project_v1_project_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_core_project_v1_project_proto_goTypes = []interface{}{
	...
	nil,                         // 2: clutch.core.project.v1.Project.DataEntry
	(*structpb.Value)(nil),      // 3: google.protobuf.Value
}
var file_core_project_v1_project_proto_depIdxs = []int32{
	2, // 0: clutch.core.project.v1.Project.data:type_name -> clutch.core.project.v1.Project.DataEntry
	1, // 1: clutch.core.project.v1.Project.dependencies:type_name -> clutch.core.project.v1.ProjectDependencies
	3, // 2: clutch.core.project.v1.Project.DataEntry.value:type_name -> google.protobuf.Value
