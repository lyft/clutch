...
type ProjectDependencies struct {
	...
	Upstreams   []*Dependency `protobuf:"bytes,1,rep,name=upstreams,proto3" json:"upstreams,omitempty"`
	Downstreams []*Dependency `protobuf:"bytes,2,rep,name=downstreams,proto3" json:"downstreams,omitempty"`
}
...
func (x *ProjectDependencies) GetUpstreams() []*Dependency {
	if x != nil {
		return x.Upstreams
	}
	return nil
...
func (x *ProjectDependencies) GetDownstreams() []*Dependency {
	if x != nil {
...
func (x *Dependency) GetTypeUrl() string {
	if x != nil {
		return x.TypeUrl
	}
	return ""
...
var file_core_project_v1_project_proto_rawDesc = []byte{
	...
	0x22, 0x9d, 0x01, 0x0a, 0x13, 0x50, 0x72, 0x6f, 0x6a, 0x65, 0x63, 0x74, 0x44, 0x65, 0x70, 0x65,
	0x6e, 0x64, 0x65, 0x6e, 0x63, 0x69, 0x65, 0x73, 0x12, 0x40, 0x0a, 0x09, 0x75, 0x70, 0x73, 0x74,
	0x72, 0x65, 0x61, 0x6d, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x22, 0x2e, 0x63, 0x6c,
	...
	0x09, 0x75, 0x70, 0x73, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x73, 0x12, 0x44, 0x0a, 0x0b, 0x64, 0x6f,
	0x77, 0x6e, 0x73, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x73, 0x18, 0x02, 0x20, 0x03, 0x28, 0x0b, 0x32,
	0x22, 0x2e, 0x63, 0x6c, 0x75, 0x74, 0x63, 0x68, 0x2e, 0x63, 0x6f, 0x72, 0x65, 0x2e, 0x70, 0x72,
	0x6f, 0x6a, 0x65, 0x63, 0x74, 0x2e, 0x76, 0x31, 0x2e, 0x44, 0x65, 0x70, 0x65, 0x6e, 0x64, 0x65,
	0x6e, 0x63, 0x79, 0x52, 0x0b, 0x64, 0x6f, 0x77, 0x6e, 0x73, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x73,
	0x22, 0x37, 0x0a, 0x0a, 0x44, 0x65, 0x70, 0x65, 0x6e, 0x64, 0x65, 0x6e, 0x63, 0x79, 0x12, 0x0e,
	...
	0x52, 0x07, 0x74, 0x79, 0x70, 0x65, 0x55, 0x72, 0x6c, 0x42, 0x3e, 0x5a, 0x3c, 0x67, 0x69, 0x74,
...
var file_core_project_v1_project_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
...
var file_core_project_v1_project_proto_depIdxs = []int32{
	...
	2, // 2: clutch.core.project.v1.ProjectDependencies.upstreams:type_name -> clutch.core.project.v1.Dependency
	2, // 3: clutch.core.project.v1.ProjectDependencies.downstreams:type_name -> clutch.core.project.v1.Dependency
	4, // 4: clutch.core.project.v1.Project.DataEntry.value:type_name -> google.protobuf.Value
